...
/**
 * A statement as a value, carrying the class the retrieve that yielded it named, so that a
 * property access can read the statement through that class's elements.
 *
