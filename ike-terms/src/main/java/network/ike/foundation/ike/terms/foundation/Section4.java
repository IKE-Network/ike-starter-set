...
final class Section4 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Has Active Ingredient (SOLOR)", PublicIds.of("65bf3b7f-c854-36b5-81c3-4915461020a8")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("3da52372-3eb8-459a-a08a-1429cff5e3e1"), IkeTerm.ENGLISH_LANGUAGE, "A domain role type from the medication model: relates a product to an ingredient active in it. Held as a SNOMED-heritage example; migrates to a domain starter set when one exists.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
