...
final class Section11 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Concept details tree table (SOLOR)", PublicIds.of("1655edd8-7b73-52c5-98b0-263d1ab3a90b")).at(inception)
                ...
                .semanticOn(PublicIds.of("d9f14a66-ee6a-42d6-8528-35235b05b1e1"), IkeTerm.US_DIALECT_PATTERN, PublicIds.of("edf525aa-5cf8-4349-93ff-03c9f7511209"), IkeTerm.PREFERRED)
                .semanticOn(PublicIds.of("38f00409-d08a-409c-b2a7-2990ae6e46c1"), IkeTerm.US_DIALECT_PATTERN, PublicIds.of("6abe3262-12c0-4ede-97d0-d7330c526002"), IkeTerm.PREFERRED)
                .semanticOn(PublicIds.of("1684fe7f-5be2-4f3f-97e6-52440a8ed3b5"), IkeTerm.US_DIALECT_PATTERN, PublicIds.of("ce3f053d-1bb6-4bc3-9b4e-0654d2d8b99d"), IkeTerm.PREFERRED)
                ;
