...
final class Section43 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Reflexive Feature (SOLOR)", PublicIds.of("7e779e4a-61ed-5c4a-aacc-03cf524b7c73")).at(inception)
                ...
                .statedAxioms(PublicIds.of("e217e187-27f3-5687-9407-05c2c61865d2"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.OBJECT_PROPERTIES))))
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of("6cd31ea8-0b07-44d3-b769-6dc3d8361258"))
                .semanticOn(PublicIds.of("8131e0b2-e9bf-43c5-b321-0b51a69f281c"), IkeTerm.US_DIALECT_PATTERN, PublicIds.of("f8c628f6-133d-4066-8400-344c429f7e3e"), IkeTerm.PREFERRED)
                .semanticOn(PublicIds.of("abed5968-5462-45ea-a0ae-64ddd5a16cc2"), IkeTerm.US_DIALECT_PATTERN, PublicIds.of("8604aed2-51ad-419c-83c3-9ec1a6f4199a"), IkeTerm.PREFERRED)
                .semanticOn(PublicIds.of("ea03caa6-658a-438c-bd46-0a14833d5c57"), IkeTerm.US_DIALECT_PATTERN, PublicIds.of("c0842297-0fb5-4c34-8135-02b717d8bd8b"), IkeTerm.PREFERRED)
                ;
