...
final class Section27 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Path coordinate properties (SOLOR)", PublicIds.of("ec41e427-f009-5e45-a643-6dc658d63d83")).at(inception)
                ...
                .statedAxioms(PublicIds.of("ab05dab4-dcc4-54a8-8119-2742d22979d8"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("View coordinate model (IkeFoundation)")))))
        ...
        set.concept("Path coordinate name (SOLOR)", PublicIds.of("a293a9a0-eb1e-5418-83c7-bec376b62245")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("bee1dc71-703e-4974-b52c-5edd942e5129"), IkeTerm.ENGLISH_LANGUAGE, "The field naming a stored path coordinate, so a surface can present saved coordinates by name.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Promotion Path for Edit Coordinate (SOLOR)", PublicIds.of("db124d3b-c1bb-530e-8fd4-577f570355be")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("700a0174-51a0-461f-a357-2d87171ce877"), IkeTerm.ENGLISH_LANGUAGE, "The edit-coordinate dimension naming the path content is promoted to when moving between paths, such as sandbox work promoted to a mainline path.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
