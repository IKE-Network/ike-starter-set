...
final class Section42 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Dialect", PublicIds.of("b9c34574-c9ac-503b-aa24-456a0ec949a2")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("18e365e5-d3ca-4683-b9ff-0f3b6b99b834"), IkeTerm.ENGLISH_LANGUAGE, "A regional or professional variety of a language, differing in which terms are preferred rather than in the language itself. Dialect semantics record whether a description is preferred or acceptable in one, and a language coordinate consults them in order.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("United States of America English dialect (SOLOR)", PublicIds.of("bca0a686-3516-3daf-8fcf-fe396d13cfad")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("1f506d54-4ef6-4a9d-b17a-6b71eb23df2b"), IkeTerm.ENGLISH_LANGUAGE, "The United States English dialect dimension: the anchor for dialect semantics recording whether a description is preferred or acceptable in US usage.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("US Nursing dialect (SOLOR)", PublicIds.of("6e447636-1085-32ff-bc36-6748a45255de")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("3c6bd686-bb75-46bb-8b0c-bdf9440b666a"), IkeTerm.ENGLISH_LANGUAGE, "The US nursing dialect: a specialization of United States English for nursing practice, where preferred terms differ from general US usage.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Standard Korean dialect (SOLOR)", PublicIds.of("f90722cc-5e40-5b9b-a2a6-f4dfa312a6a9")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("5db6074f-7d2c-46a3-b624-ced9f610877c"), IkeTerm.ENGLISH_LANGUAGE, "The standard Korean dialect: the general-usage dialect of Korean, as opposed to any specialized register.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
