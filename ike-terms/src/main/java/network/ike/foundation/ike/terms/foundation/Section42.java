...
final class Section42 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("French dialect (SOLOR)", PublicIds.of("75d00a0d-8e46-5e42-ad34-3e46269b28a3")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("661c3b42-e715-4f49-b5a7-94513c91042e"), IkeTerm.ENGLISH_LANGUAGE, "French dialect", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Czech dialect (SOLOR)", PublicIds.of("6979e268-0b59-542f-bac0-313c5ddf6a2e")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("bd600561-1f19-4967-ad78-fbb7100d2d85"), IkeTerm.ENGLISH_LANGUAGE, "Czech dialect", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("United States of America English dialect (SOLOR)", PublicIds.of("bca0a686-3516-3daf-8fcf-fe396d13cfad")).at(inception)
                ...
                .statedAxioms(PublicIds.of("2a5ec588-b8d5-5330-9655-57d94e458c27"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.ENGLISH_DIALECT_ASSEMBLAGE))))
        ...
        set.concept("Great Britain English dialect", PublicIds.of("eb9a5e42-3cba-356d-b623-3ed472e20b30")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("c5140135-7131-4b83-9c20-63fb31ff4978"), IkeTerm.ENGLISH_LANGUAGE, "GB English dialect / GB English", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("9d20953a-fcd8-590e-94dc-305378a1b0d9"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.ENGLISH_DIALECT_ASSEMBLAGE))))
        ...
        set.concept("Korean dialect (SOLOR)", PublicIds.of("6fb2eb9c-fb9e-5959-802c-fb17bcba3079")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("bfed8bdf-10b5-425b-8a49-49220ea375a3"), IkeTerm.ENGLISH_LANGUAGE, "Korean dialect", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Irish dialect (SOLOR)", PublicIds.of("c0f77638-6274-5b40-b832-ac1cba7ec515")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("aec9a33b-933b-4d2c-bf84-3dc42eb756ae"), IkeTerm.ENGLISH_LANGUAGE, "Irish dialect", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Russian dialect (SOLOR)", PublicIds.of("300126d1-2604-579f-a59b-e3c1179a173a")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("f51277d0-9090-410a-9d73-933ad0eb94ad"), IkeTerm.ENGLISH_LANGUAGE, "Russian Dialect", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Polish dialect (SOLOR)", PublicIds.of("315cd879-1557-5a30-b325-a5d3df9e1c2b")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("48fca292-79ea-4728-9bb1-02f3b01e4045"), IkeTerm.ENGLISH_LANGUAGE, "Polish Dialect", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
