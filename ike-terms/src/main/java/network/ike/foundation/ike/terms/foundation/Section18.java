...
final class Section18 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Property set (SOLOR)", PublicIds.of(UUID.fromString("e273b5c0-c012-5e53-990c-aec5c2cb33a7"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("22bbf247-37b9-5d7a-b6d8-74420e9e83a2")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Logical set (IkeFoundation)")))))
        ...
        set.concept("Feature (SOLOR)", PublicIds.of(UUID.fromString("5e76a88e-794a-5fdd-8eb2-4a9e4b1386b6"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("c1e45623-1c5b-5f32-859f-097cf115fc72")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Typed atom (IkeFoundation)")))))
