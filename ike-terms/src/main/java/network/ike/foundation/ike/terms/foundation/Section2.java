...
final class Section2 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Language", PublicIds.of("f56fa231-10f9-5e7f-a86d-a1d61b5b56e3")).at(inception)
                ...
                .statedAxioms(PublicIds.of("8772f036-a392-5231-94e7-9964c2497ccc"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.TINKAR_MODEL_CONCEPT))))
        ...
        set.concept("Irish language (SOLOR)", PublicIds.of("58e82fc4-1492-5cf8-8997-43800360bbd6")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("356fcaed-0d26-4247-9d57-4c2cc36a3b23"), IkeTerm.ENGLISH_LANGUAGE, "Irish language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("English Language", PublicIds.of("02018e5a-46ba-5297-92f1-6931b9f98a12", "06d905ea-c647-3af9-bfe5-2514e135b558", "45021920-9567-11e5-8994-feff819cdc9f")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("11f09c95-a5eb-419b-8de5-8a0d72c46a7e"), IkeTerm.ENGLISH_LANGUAGE, "Value for description language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Czech language (SOLOR)", PublicIds.of("33aa2d26-0541-557c-b796-904cbf245101")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("a92013e4-0fa5-4562-ada2-f683d02b0ebb"), IkeTerm.ENGLISH_LANGUAGE, "Czech Language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Danish language (SOLOR)", PublicIds.of("987681fb-f3ef-595d-90e2-067baf2bc71f", "45021f10-9567-11e5-8994-feff819cdc9f", "7e462e33-6d94-38ae-a044-492a857a6853")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("54e3ffec-09e2-47b7-bcb9-0bbfb39230d6"), IkeTerm.ENGLISH_LANGUAGE, "Danish Language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("French Language (SOLOR)", PublicIds.of("8b23e636-a0bd-30fb-b8e2-1f77eaa3a87e", "01707e47-5f6d-555e-80af-3c1ffb297eaa", "45021dbc-9567-11e5-8994-feff819cdc9f")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("26b8abbf-96f4-485e-9593-175dcc292dfa"), IkeTerm.ENGLISH_LANGUAGE, "French Language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("German Language (SOLOR)", PublicIds.of("5f144b18-76a8-5c7e-8480-55a5030d707f")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("56534ec6-2f32-42ba-81bd-4016bd292720"), IkeTerm.ENGLISH_LANGUAGE, "German Language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Polish Language (Language)", PublicIds.of("c924b887-da88-3a72-b8ea-fa86990467c9", "45022140-9567-11e5-8994-feff819cdc9f")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("cd2aa44c-2ce7-46b0-8d1d-104977c162d5"), IkeTerm.ENGLISH_LANGUAGE, "Polish Language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Italian Language (SOLOR)", PublicIds.of("bdd59458-381a-5818-8577-60525f11ac6c")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("1f820a2a-03f0-44b7-87ad-42b10ead09b0"), IkeTerm.ENGLISH_LANGUAGE, "Italian language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Korean Language (SOLOR)", PublicIds.of("1464f995-d658-5e9d-86e0-8308a6fa57eb")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("ea286819-1568-4d18-884e-ff917a12e165"), IkeTerm.ENGLISH_LANGUAGE, "Korean language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Swedish language (SOLOR)", PublicIds.of("9784a791-8fdb-32f7-88da-74ab135fe4e3", "45022848-9567-11e5-8994-feff819cdc9f")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("0e358951-551a-4af3-9dbc-de56ac9b1b7d"), IkeTerm.ENGLISH_LANGUAGE, "Swedish Language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Russian language (SOLOR)", PublicIds.of("0818dbb7-3fe1-59d7-99c2-c8dc42ff2cce")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("4e771211-a2b5-4549-9d9b-dbbc56dc49bf"), IkeTerm.ENGLISH_LANGUAGE, "Russian language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Chinese language (SOLOR)", PublicIds.of("aacbc859-e9a0-5e01-b6a9-9a255a47b0c9", "ba2efe6b-fe56-3d91-ae0f-3b389628f74c", "45022532-9567-11e5-8994-feff819cdc9f")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("f2c6d51f-e245-433b-99ee-32ee95512e21"), IkeTerm.ENGLISH_LANGUAGE, "Chinese language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Lithuanian language (SOLOR)", PublicIds.of("8fa63274-70e3-5b11-9669-1b7bdb372b1a", "e9645d95-8a1f-3825-8feb-0bc2ee825694", "45022410-9567-11e5-8994-feff819cdc9f")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("974f2cde-9f03-486c-903e-0af36d80c730"), IkeTerm.ENGLISH_LANGUAGE, "Lithuanian Language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Spanish language", PublicIds.of("0fcf44fb-d0a7-3a67-bc9f-eb3065ed3c8e", "45021c36-9567-11e5-8994-feff819cdc9f")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("77a9358c-593b-4b86-be10-6c9de7833eb0"), IkeTerm.ENGLISH_LANGUAGE, "Value for the description language dialect", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Dutch language (SOLOR)", PublicIds.of("21d11bd1-3dab-5034-9625-81b9ae2bd8e7", "45022280-9567-11e5-8994-feff819cdc9f", "674ad858-0224-3f90-bcf0-bc4cab753d2d")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("31e1a2cd-b330-4857-8caf-b54ae74707ac"), IkeTerm.ENGLISH_LANGUAGE, "Dutch language", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
