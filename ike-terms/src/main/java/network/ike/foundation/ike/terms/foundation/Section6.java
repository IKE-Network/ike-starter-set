...
final class Section6 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Path for user (SOLOR)", PublicIds.of(UUID.fromString("12131382-1535-5a77-928b-6eacad221ea2"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("ee57f842-3187-42a2-a285-3fa092552d18")), IkeTerm.ENGLISH_LANGUAGE, "A user's working-path preference — application preference machinery inherited from the baseline, not a kind of user. Filed under Legacy as a removal candidate.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Order for concept attachments  (SOLOR)", PublicIds.of(UUID.fromString("6167efcb-50e8-534d-9827-fdd60b02ae00"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("e267db9d-ab3e-426d-9841-e7b09193da88")), IkeTerm.ENGLISH_LANGUAGE, "A user-interface ordering preference for concept attachments — application machinery inherited from the baseline, not a kind of user. Filed under Legacy as a removal candidate.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Order for description attachments (SOLOR)", PublicIds.of(UUID.fromString("69ee3f13-e2ba-5a96-9b91-5eecfad8e587"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("981fa129-e4cd-4132-8a21-e2ba11f4b6e7")), IkeTerm.ENGLISH_LANGUAGE, "A user-interface ordering preference for description attachments — application machinery inherited from the baseline, not a kind of user. Filed under Legacy as a removal candidate.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Module for user (SOLOR)", PublicIds.of(UUID.fromString("c8fd4f1b-d842-5245-9a7d-a58dc0ac1c11"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("cc33a3cb-3781-4745-8a88-e65fa6b47ed3")), IkeTerm.ENGLISH_LANGUAGE, "A user's module preference — application preference machinery inherited from the baseline, not a kind of user. Filed under Legacy as a removal candidate.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Order for axiom attachments (SOLOR)", PublicIds.of(UUID.fromString("abcb0946-20e1-5483-8469-3e8fa0ce20c4"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("42bd0984-8d26-43b4-a6ed-22928a6f7847")), IkeTerm.ENGLISH_LANGUAGE, "A user-interface ordering preference for axiom attachments — application machinery inherited from the baseline, not a kind of user. Filed under Legacy as a removal candidate.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
