...
final class Section6 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Gretel (User)", PublicIds.of("1c0023ed-559e-3311-9e55-bd4bd9e5628f")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("c50f3345-e1d9-4103-bf2e-55739f777f3b"), IkeTerm.ENGLISH_LANGUAGE, "The default editing identity a fresh Komet installation offers, so a user can author before establishing their own author concept.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Path for user (SOLOR)", PublicIds.of("12131382-1535-5a77-928b-6eacad221ea2")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("ee57f842-3187-42a2-a285-3fa092552d18"), IkeTerm.ENGLISH_LANGUAGE, "The per-user editing default naming which version-control path a user's edits land on.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("82e846f7-76a5-526c-96b5-20e64f1719ae"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("View coordinate model (IkeFoundation)")))))
        ...
        set.concept("Order for concept attachments  (SOLOR)", PublicIds.of("6167efcb-50e8-534d-9827-fdd60b02ae00")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("e267db9d-ab3e-426d-9841-e7b09193da88"), IkeTerm.ENGLISH_LANGUAGE, "The per-user display preference fixing the order a concept's attached semantics are presented in.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("446cb1de-7ac9-5fb1-aebe-f54e4f453037"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("View coordinate model (IkeFoundation)")))))
        ...
        set.concept("Order for description attachments (SOLOR)", PublicIds.of("69ee3f13-e2ba-5a96-9b91-5eecfad8e587")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("981fa129-e4cd-4132-8a21-e2ba11f4b6e7"), IkeTerm.ENGLISH_LANGUAGE, "The per-user display preference fixing the order a description's attached semantics, such as dialect judgments, are presented in.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("c0ecad74-1af6-534b-bd48-64100abc830c"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("View coordinate model (IkeFoundation)")))))
        ...
        set.concept("Starter Data Authoring (SOLOR)", PublicIds.of("070deb74-acc5-46bf-b9c6-eaee1b58ef52")).at(inception)
                ...
                .statedAxioms(PublicIds.of("4f899d97-b46b-5d9e-afe3-52b0e098c676"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Provenance model (IkeFoundation)")), leb.ConceptAxiom(IkeTerm.MEANING))))
        ...
        set.concept("Module for user (SOLOR)", PublicIds.of("c8fd4f1b-d842-5245-9a7d-a58dc0ac1c11")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("cc33a3cb-3781-4745-8a88-e65fa6b47ed3"), IkeTerm.ENGLISH_LANGUAGE, "The per-user editing default naming which module a user's edits land in.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("afcddf70-7b86-5f14-9f9c-6f2826b40691"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("View coordinate model (IkeFoundation)")))))
        ...
        set.concept("Tinkar Starter Data Author (User)", PublicIds.of("dd96b2ea-6d7b-3791-ad74-bbdc67c493c1")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("6c1f2d80-e384-4af3-a3a6-d763546d978a"), IkeTerm.ENGLISH_LANGUAGE, "The author identity the upstream starter data was committed under, retained for the historic versions consumers already hold; this set's own content is authored by IKE Community.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Order for axiom attachments (SOLOR)", PublicIds.of("abcb0946-20e1-5483-8469-3e8fa0ce20c4")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("42bd0984-8d26-43b4-a6ed-22928a6f7847"), IkeTerm.ENGLISH_LANGUAGE, "The per-user display preference fixing the order an axiom's attached semantics are presented in.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("8dbb8e28-d4c1-5d7f-a003-d99a395d29ed"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("View coordinate model (IkeFoundation)")))))
        ...
        set.concept("KOMET user list", PublicIds.of("5e77558d-97d0-52b6-adf0-d54beb97b3a6")).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("3bc9a41e-a61e-4aab-80a9-f4da03131a97"), IkeTerm.ENGLISH_LANGUAGE, "KOMET user list", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("f0dd8d7e-5733-4dbf-8ab5-ff4a3b4272ca"), IkeTerm.ENGLISH_LANGUAGE, "The roster of author identities a Komet installation offers at sign-in.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("0979c33c-4a97-5e72-8efd-a42a098ce2d4"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Editorial model (IkeFoundation)")))))
