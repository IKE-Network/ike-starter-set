...
final class Section19 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("DiGraph data type", PublicIds.of(UUID.fromString("60113dfe-2bad-11eb-adc1-0242ac120002"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("242ac229-b3f9-4562-a320-87fa74b77638")), IkeTerm.ENGLISH_LANGUAGE, "A field data type whose values are directed graphs — the structure kind named by Directed graph (DiGraph) under Graph. A display-field concept about that structure, not a kind of graph, which is why it lives under Display Fields rather than in the graph family (IKE-Network/ike-issues#950).", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("DiTree data type", PublicIds.of(UUID.fromString("32f64fc6-5371-11eb-ae93-0242ac130002"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("2eca023f-90a9-4aaf-a835-b19d8ea1c8a7")), IkeTerm.ENGLISH_LANGUAGE, "A field data type whose values are directed trees — the structure kind named by Directed tree (DiTree) under Directed graph and Tree; each stored logical expression is one such value. A display-field concept about that structure, not a kind of tree, which is why it lives under Display Fields rather than in the graph family (IKE-Network/ike-issues#950).", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
