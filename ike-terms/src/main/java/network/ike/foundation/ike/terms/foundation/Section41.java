...
final class Section41 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Definition root (SOLOR)", PublicIds.of(UUID.fromString("e7271c01-6ed4-5240-963f-34d1f24153b0"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("47a048e5-d731-5961-a989-4f4088fa5ef2")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Logical expression vertex (IkeFoundation)")))))
        ...
        set.concept("Concept reference (SOLOR)", PublicIds.of(UUID.fromString("e89148c7-4fe2-52f8-abb9-6a53605d20cb"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("d42be61b-7e1e-5e2a-9b04-4f36b30e0e2e")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Logical expression vertex (IkeFoundation)")))))
        ...
        set.concept("EL++ AND (SOLOR)", PublicIds.of(UUID.fromString("fa113d51-07d2-587c-8930-0bce207d506d"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("67fbbff2-ee64-4cc4-ad55-10341abf791c")), IkeTerm.ENGLISH_LANGUAGE, "EL++ AND (SOLOR)", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("fe20c680-3ce1-4183-9932-9f8f7d3b6d47")), IkeTerm.ENGLISH_LANGUAGE, "EL++ AND", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("da48766d-c894-4b83-8848-0c384503ec35")), IkeTerm.ENGLISH_LANGUAGE, "A connective operator that joins two or more classes and requires every one of them: the result is the class of things that belong to every operand class, their intersection. The EL++ conjunction, and the connective every stated axiom in this set is built with. Renamed and re-parented in place from the inherited And (IKE-Network/ike-issues#1089).", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("62a05e95-5cff-57d1-9d4e-d7ac7dfd2764")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Generic AND (IkeFoundation)")))))
        ...
        set.concept("Generic OR (SOLOR)", PublicIds.of(UUID.fromString("2c940bcf-22a8-5fc9-b232-580021e758ed"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("d1bdda9f-406e-48bc-ad51-b8b5a98ef8b6")), IkeTerm.ENGLISH_LANGUAGE, "Generic OR (SOLOR)", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("31ff3b02-bc11-4961-ab92-98445fef6666")), IkeTerm.ENGLISH_LANGUAGE, "Generic OR", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("86aa1210-ce5b-43c0-8992-7bbec849a129")), IkeTerm.ENGLISH_LANGUAGE, "A connective operator that joins two or more operands of one kind into a result of that same kind. The operation combines all of the operands to produce the result, and their order and grouping make no difference. OR means any one operand is enough, so the result is whatever is at least one of the operands. Adding another operand can only widen the result, never narrow it. Each descendant applies this to one kind of operand: Set OR keeps the members found in any operand set, whatever kind of thing they are, and Presence OR is Present when any operand is Present. EL++ has no OR, so there is no class instance; the inherited Or concept is the generic itself, keeping the identity the axiom adaptor holds for a disjunction vertex (IKE-Network/ike-issues#1089).", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
