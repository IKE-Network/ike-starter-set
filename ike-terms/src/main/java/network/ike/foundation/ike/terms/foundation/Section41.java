...
final class Section41 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Connective operator (SOLOR)", PublicIds.of(UUID.fromString("3fdcaadc-d972-58e9-84f1-b3a39903b076"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("31c7ab09-a4fa-59b6-837a-527f61bc00db")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Atom (IkeFoundation)")))))
        ...
        set.concept("Part of (SOLOR)", PublicIds.of(UUID.fromString("b4c3f6f9-6937-30fd-8412-d0c77f8a7f73"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("d26656f3-219b-577c-ac5d-84d397928be0")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.TAXONOMY_OPERATOR))))
        ...
        set.concept("Definition root (SOLOR)", PublicIds.of(UUID.fromString("e7271c01-6ed4-5240-963f-34d1f24153b0"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("47a048e5-d731-5961-a989-4f4088fa5ef2")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Logical axiom (IkeFoundation)")))))
        ...
        set.concept("Concept reference (SOLOR)", PublicIds.of(UUID.fromString("e89148c7-4fe2-52f8-abb9-6a53605d20cb"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("d42be61b-7e1e-5e2a-9b04-4f36b30e0e2e")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Atom (IkeFoundation)")))))
        ...
        set.concept("Disjoint with (SOLOR)", PublicIds.of(UUID.fromString("f8433993-9a2d-5377-b564-80a45c7b7824"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("ea322501-e677-5423-a234-f834b72b3874")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Atom (IkeFoundation)")))))
