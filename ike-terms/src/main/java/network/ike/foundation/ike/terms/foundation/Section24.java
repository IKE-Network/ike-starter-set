...
final class Section24 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Referenced component for semantic", PublicIds.of("a9ba4749-c11f-5f35-a991-21796fb89ddc")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("b2322b09-b1a9-4cf9-a62e-cbc46a87d088"), IkeTerm.ENGLISH_LANGUAGE, "The field naming the component a semantic is attached to, in the semantic-properties vocabulary. Duplicates Component for semantic and the Semantic referenced component field kind; retained for identity compatibility.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("3e4e3641-efbb-5362-b5d8-5d6494fd0143"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Legacy model concepts (IkeFoundation)")))))
        ...
        set.concept("Component for semantic (SOLOR)", PublicIds.of("0bc32c16-698e-5719-8bd5-efa099c7d782")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("1dffac55-e9cc-4dfa-97b2-f6eaa24178c6"), IkeTerm.ENGLISH_LANGUAGE, "The field naming the component a semantic is attached to, in the semantic-properties vocabulary. Duplicates Referenced component for semantic and the live Semantic referenced component field kind, which is what pattern declarations actually use; retained for identity compatibility.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("8946c895-34dc-59fb-8d5d-de6f100a2468"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Legacy model concepts (IkeFoundation)")))))
        ...
        set.concept("Logic graph for semantic (SOLOR)", PublicIds.of("fc2a0662-2396-575b-95f0-e9b38a418620")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("8dc5703e-37d8-483f-ad87-f7f952c49749"), IkeTerm.ENGLISH_LANGUAGE, "The field holding a semantic's logical expression graph: the definition a logical-expression semantic carries.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Semantic field name (SOLOR)", PublicIds.of("15489c68-673d-503e-bff7-e9d59e5dc15c")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("2be447bf-a577-4d07-84fc-a16b627ec09f"), IkeTerm.ENGLISH_LANGUAGE, "The field holding a display name for one of a semantic's fields, for surfaces that label fields individually.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
