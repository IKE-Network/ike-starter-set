...
final class Section32 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Property sequence implication", PublicIds.of(UUID.fromString("9a47a5db-42a6-49ee-9083-54bc305a9456"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("14f32de1-40b0-599b-bbaf-017aed72d2e8")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Atom (IkeFoundation)")))))
