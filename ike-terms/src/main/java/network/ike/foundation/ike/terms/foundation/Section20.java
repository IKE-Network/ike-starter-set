...
final class Section20 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Version list for chronicle (SOLOR)", PublicIds.of("d6f27f80-8e20-58fe-8d69-66ad4644f969")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("5459708c-1981-40e2-9a8d-83b007b77fe9"), IkeTerm.ENGLISH_LANGUAGE, "The field holding a chronicle's complete version list, in commit order.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Semantic list for chronicle (SOLOR)", PublicIds.of("c809b2c0-9235-5f64-bbda-34210d91bdf8")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("d0cbb158-4d10-46f2-9aad-aab21766c895"), IkeTerm.ENGLISH_LANGUAGE, "The field holding every semantic attached to a chronicle's component -- its descriptions, identifiers, axioms, and memberships.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
