...
final class Section20 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Chronicle properties (SOLOR)", PublicIds.of("2ba2ef47-30af-57ec-9073-38693f020d7e")).at(inception)
                ...
                .statedAxioms(PublicIds.of("0fced50b-a581-5111-bbfc-cc1fcaf7f79f"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.OBJECT_PROPERTIES))))
        ...
        set.concept("Primordial UUID for chronicle (SOLOR)", PublicIds.of("e0fcafbc-7191-5cdc-b14a-19d4d97f71bd")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("d65c236c-0c1a-49f9-b711-7cbc26ef8ef4"), IkeTerm.ENGLISH_LANGUAGE, "Primordial UUID", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("UUID list for component (SOLOR)", PublicIds.of("f8e3238e-7424-5a40-8649-a8d164382fec")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("cd03b57c-ba73-459f-a36b-e566aeccfb02"), IkeTerm.ENGLISH_LANGUAGE, "UUIDs", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
