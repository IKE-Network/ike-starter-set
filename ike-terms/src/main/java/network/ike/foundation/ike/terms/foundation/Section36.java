...
final class Section36 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Correlation reference expression (SOLOR)", PublicIds.of("acb73d95-7c96-590c-9f24-23da54f95ff2")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("c43860eb-03bc-486a-965f-ff04e89271a6"), IkeTerm.ENGLISH_LANGUAGE, "The reference side of a correlation: the expression an authored expression is compared against when checking whether two expressions correspond.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Correlation expression (SOLOR)", PublicIds.of("1711815f-99a1-5d1a-8f1e-75dc7bf41928")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("311c6d54-29a6-40cb-8275-f3a1f8d7d88d"), IkeTerm.ENGLISH_LANGUAGE, "The subject side of a correlation: the expression being checked for correspondence against a reference expression.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
