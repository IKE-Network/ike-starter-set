...
final class Section68 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Relationship destination", PublicIds.of(UUID.fromString("a3dd69af-355c-54ce-ba13-2902a7ae9551"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("29f2bc26-565f-4a6c-aa27-d9615eb51767")), IkeTerm.ENGLISH_LANGUAGE, "Signifies path to child concepts which are more specific than the concept", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
