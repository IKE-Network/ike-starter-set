...
final class Section25 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Value Constraint Source (SOLOR)", PublicIds.of("09aa031a-6290-4ec9-a44c-23928a767da3")).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("5a2b4035-b9b2-4ba7-94cc-2247d9da4ac7"), IkeTerm.ENGLISH_LANGUAGE, "Value Constraint Source (SOLOR)", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semanticOn(PublicIds.of("048579fe-498b-4a26-89d0-022a3ac8b457"), IkeTerm.US_DIALECT_PATTERN, PublicIds.of("266afb7f-aada-456a-b84a-5a1ce1cc4917"), IkeTerm.PREFERRED)
                ;
