...
final class Section37 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Description", PublicIds.of("87118daf-d28c-55fb-8657-cd6bc8425600")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("2c6412c9-53c7-40f2-9771-b0ccd8333f4e"), IkeTerm.ENGLISH_LANGUAGE, "Human-readable text attached to a component: the words a person reads where the machinery holds an identity. Every rendering surface resolves one, choosing by language, dialect, and description type.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("2f6ecd40-16c2-554d-8441-985afe25f358"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.TINKAR_MODEL_CONCEPT), leb.ConceptAxiom(IkeTerm.PURPOSE))))
