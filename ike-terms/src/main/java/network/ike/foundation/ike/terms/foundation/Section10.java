...
final class Section10 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Necessary set", PublicIds.of(UUID.fromString("acaa2eba-8364-5493-b24c-b3884d34bb60"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("2e34b3ee-a3fa-5a91-9908-84ba3fd08f65")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Logical set (IkeFoundation)")))))
        ...
        set.concept("Inclusion set", PublicIds.of(UUID.fromString("def77c09-e1eb-40f2-931a-e7cf2ce0e597"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("21a2f5cb-5e71-5051-8fb1-7cb2310df095")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Logical set (IkeFoundation)")))))
        ...
        set.concept("Role group", PublicIds.of(UUID.fromString("a63f4bf2-a040-11e5-8994-feff819cdc9f"), UUID.fromString("f97abff6-a221-57a1-9cd6-e79e723bfe2a"), UUID.fromString("051fbfed-3c40-3130-8c09-889cb7b7b5b6"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("286556d5-021b-58de-8e1b-5c2214eefc49")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.ROLE_TYPE))))
        ...
        set.concept("Role", PublicIds.of(UUID.fromString("46ae9325-dd24-5008-8fda-80cf1f0977c7"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("403755ab-e752-5f8c-8a14-974739e31cbd")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Typed atom (IkeFoundation)")))))
        ...
        set.concept("Sufficient set", PublicIds.of(UUID.fromString("8aa48cfd-485b-5140-beb9-0d122f7812d9"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("be162423-8f34-57f0-8a23-abf799e6274d")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Logical set (IkeFoundation)")))))
        ...
        set.concept("Necessary but not sufficient concept definition (SOLOR)", PublicIds.of(UUID.fromString("e1a12059-3b01-3296-9532-d10e49d0afc3"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("c042aafb-bcfc-51eb-bc91-d535208375cf")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Logical set (IkeFoundation)")))))
