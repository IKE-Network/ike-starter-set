...
final class Section71 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.pattern("Semantic version field pattern", PublicIds.of(UUID.fromString("82f93e84-cee1-44bc-bb6d-4cc2a722048b"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("d47fdb46-8ce0-4405-943a-b2420c7480f8")), IkeTerm.ENGLISH_LANGUAGE, "Semantic version field pattern", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("2caeaa6d-865c-4e61-8d48-c003487ee067")), IkeTerm.ENGLISH_LANGUAGE, "Semantic version field pattern", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
