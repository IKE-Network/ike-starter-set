...
final class Section63 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Creative Commons BY license (SOLOR)", PublicIds.of("3415a972-7850-57cd-aa86-a572ca1c2ceb")).at(inception)
                ...
                .statedAxioms(PublicIds.of("d27af530-31d3-5921-8f87-f4e3f0467593"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Provenance model (IkeFoundation)")))))
