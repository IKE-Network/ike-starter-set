...
public final class IkeTerm {
    ...
    public static final EntityProxy.Concept ACCEPTABLE =
            EntityProxy.Concept.make("Acceptable (SOLOR)", PublicIds.of("12b9e103-060e-3256-9982-18c1191af60e"));
    ...
    public static final EntityProxy.Concept ACTION_PROPERTIES =
            EntityProxy.Concept.make("Action properties (SOLOR)", PublicIds.of("80ba281c-7d47-57cf-8100-82b69bce998b"));
    ...
    public static final EntityProxy.Concept ANNOTATION_TYPE =
            EntityProxy.Concept.make("Annotation type (SOLOR)", PublicIds.of("3fe77951-58c9-51b3-8e7e-65edcf7ace0a"));

    /** {@code Array field (SOLOR)} — same identity as {@code TinkarTerm.ARRAY_FIELD}. */
    public static final EntityProxy.Concept ARRAY_FIELD =
            EntityProxy.Concept.make("Array field (SOLOR)", PublicIds.of("b168ad04-f814-5036-b886-fd4913de88c8"));
    ...
    public static final EntityProxy.Concept AUTHOR_FOR_VERSION =
            EntityProxy.Concept.make("Author for version (SOLOR)", PublicIds.of("4eb9de0d-7486-5f18-a9b4-82e3432f4103"));
    ...
    public static final EntityProxy.Concept AXIOM_ORIGIN =
            EntityProxy.Concept.make("Axiom origin (SOLOR)", PublicIds.of("b868bd83-5cd4-5d84-9cf7-b08674fbc79b"));
    ...
    public static final EntityProxy.Concept AXIOM_SYNTAX =
            EntityProxy.Concept.make("Axiom Syntax (SOLOR)", PublicIds.of("8da1c508-c2a2-4899-b26d-87f8b98a7558"));
    ...
    public static final EntityProxy.Concept BOOLEAN_FIELD =
            EntityProxy.Concept.make("Boolean field (SOLOR)", PublicIds.of("d6b9e2cc-31c6-5e80-91b7-7537690aae32"));
    ...
    public static final EntityProxy.Concept BYTE_ARRAY_FIELD =
            EntityProxy.Concept.make("Byte array field (SOLOR)", PublicIds.of("dbdd8df2-aec3-596b-88fc-7b83b5594a45"));
    ...
    public static final EntityProxy.Concept CHRONICLE_PROPERTIES =
            EntityProxy.Concept.make("Chronicle properties (SOLOR)", PublicIds.of("2ba2ef47-30af-57ec-9073-38693f020d7e"));

    /** {@code Comment (SOLOR)} — same identity as {@code TinkarTerm.COMMENT}. */
    public static final EntityProxy.Concept COMMENT =
            EntityProxy.Concept.make("Comment (SOLOR)", PublicIds.of("147832d4-b9b8-5062-8891-19f9c4e4760a"));
    ...
    public static final EntityProxy.Concept COMPONENT_FIELD =
            EntityProxy.Concept.make("Component field (SOLOR)", PublicIds.of("fb00d132-fcc3-5cbf-881d-4bcc4b4c91b3"));
    ...
    public static final EntityProxy.Concept COMPONENT_ID_LIST_FIELD =
            EntityProxy.Concept.make("Component Id list field (SOLOR)", PublicIds.of("e553d3f1-63e1-4292-a3a9-af646fe44292"));
    ...
    public static final EntityProxy.Concept COMPONENT_ID_SET_FIELD =
            EntityProxy.Concept.make("Component Id set field (SOLOR)", PublicIds.of("e283af51-2e8f-44fa-9bf1-89a99a7c7631"));
    ...
    public static final EntityProxy.Concept COMPONENT_TYPE_FOCUS =
            EntityProxy.Concept.make("Component type focus (SOLOR)", PublicIds.of("f1f179d0-26af-5123-9b29-9fc6cd01dd29"));
    ...
    public static final EntityProxy.Concept CONCEPT_TYPE =
            EntityProxy.Concept.make("Concept type (SOLOR)", PublicIds.of("106f3ba1-63b8-5596-8dbe-524fa2e89fc0"));
    ...
    public static final EntityProxy.Concept CONCRETE_DOMAIN_OPERATOR =
            EntityProxy.Concept.make("Concrete domain operator (SOLOR)", PublicIds.of("843b0b55-8785-5544-93f6-581da9cf1ff3"));
    ...
    public static final EntityProxy.Concept CONNECTIVE_OPERATOR =
            EntityProxy.Concept.make("Connective operator (SOLOR)", PublicIds.of("3fdcaadc-d972-58e9-84f1-b3a39903b076"));
    ...
    public static final EntityProxy.Concept CORRELATION_PROPERTIES =
            EntityProxy.Concept.make("Correlation properties (SOLOR)", PublicIds.of("8f682e00-3d9e-5506-bd19-b2169d6c8752"));
    ...
    public static final EntityProxy.Concept DECIMAL_FIELD =
            EntityProxy.Concept.make("Decimal field (SOLOR)", PublicIds.of("b413fe94-4ada-4aee-96f9-22be19699d40"));
    ...
    public static final EntityProxy.Concept DEFINITION_DESCRIPTION_TYPE =
            EntityProxy.Concept.make("Definition description type (SOLOR)", PublicIds.of("700546a3-09c7-3fc2-9eb9-53d318659a09"));

    /** {@code Description (SOLOR)} — same identity as {@code TinkarTerm.DESCRIPTION}. */
    public static final EntityProxy.Concept DESCRIPTION =
            EntityProxy.Concept.make("Description (SOLOR)", PublicIds.of("87118daf-d28c-55fb-8657-cd6bc8425600"));
    ...
    public static final EntityProxy.Concept DESCRIPTION_ACCEPTABILITY =
            EntityProxy.Concept.make("Description acceptability (SOLOR)", PublicIds.of("96b61063-0d29-5aea-9652-3f5f328aadc3"));
    ...
    public static final EntityProxy.Concept DESCRIPTION_CASE_SIGNIFICANCE =
            EntityProxy.Concept.make("Description case significance (SOLOR)", PublicIds.of("c3dde9ea-b144-5f49-845a-20cc7d305250", "f30b0312-2c85-3e65-8609-2d89f8437d34"));
    ...
    public static final EntityProxy.Concept DESCRIPTION_DIALECT_PAIR =
            EntityProxy.Concept.make("Description dialect pair (SOLOR)", PublicIds.of("a27bbbf8-57b5-590c-8650-1247f6f963eb"));
    ...
    public static final EntityProxy.Concept DESCRIPTION_LOGIC_PROFILE =
            EntityProxy.Concept.make("Description-logic profile (SOLOR)", PublicIds.of("14eadb10-fbd0-5999-af37-05728a8503af"));
    ...
    public static final EntityProxy.Concept DESCRIPTION_NOT_CASE_SENSITIVE =
            EntityProxy.Concept.make("Description not case sensitive (SOLOR)", PublicIds.of("ecea41a2-f596-3d98-99d1-771b667e55b8"));
    ...
    public static final EntityProxy.Pattern DESCRIPTION_PATTERN =
            EntityProxy.Pattern.make("Description pattern", PublicIds.of("a4de0039-2625-5842-8a4c-d1ce6aebf021"));
    ...
    public static final EntityProxy.Concept DESCRIPTION_SEMANTIC =
            EntityProxy.Concept.make("Description semantic (SOLOR)", PublicIds.of("81487d5f-6115-51e2-a3b3-93d783888eb8"));
    ...
    public static final EntityProxy.Concept DESCRIPTION_TYPE =
            EntityProxy.Concept.make("Description type (SOLOR)", PublicIds.of("ad0c19e8-2ccc-59c1-8b7e-c56c03aca8eb"));
    ...
    public static final EntityProxy.Concept DESCRIPTION_VERSION_PROPERTIES =
            EntityProxy.Concept.make("Description version properties (SOLOR)", PublicIds.of("732aad24-4add-59d6-bbc9-840a8b9dc754"));
    ...
    public static final EntityProxy.Concept DEVELOPMENT_PATH =
            EntityProxy.Concept.make("Development path (SOLOR)", PublicIds.of("1f200ca6-960e-11e5-8994-feff819cdc9f"));
    ...
    public static final EntityProxy.Concept DIALECT_ASSEMBLAGE =
            EntityProxy.Concept.make("Dialect assemblage (SOLOR)", PublicIds.of("b9c34574-c9ac-503b-aa24-456a0ec949a2"));
    ...
    public static final EntityProxy.Concept DIGRAPH_FIELD =
            EntityProxy.Concept.make("DiGraph field (SOLOR)", PublicIds.of("60113dfe-2bad-11eb-adc1-0242ac120002"));
    ...
    public static final EntityProxy.Concept DIRECTED_GRAPH =
            EntityProxy.Concept.make("Directed graph (SOLOR)", PublicIds.of("47a787a7-bdce-528d-bfcc-fde1add8d599"));
    ...
    public static final EntityProxy.Concept DISPLAY_FIELDS =
            EntityProxy.Concept.make("Display Fields (SOLOR)", PublicIds.of("4e627b9c-cecb-5563-82fc-cb0ee25113b1"));
    ...
    public static final EntityProxy.Concept DITREE_FIELD =
            EntityProxy.Concept.make("DiTree field (SOLOR)", PublicIds.of("32f64fc6-5371-11eb-ae93-0242ac130002"));
    ...
    public static final EntityProxy.Concept DYNAMIC_COLUMN_DATA_TYPES =
            EntityProxy.Concept.make("Dynamic column data types (SOLOR)", PublicIds.of("61da7e50-f606-5ba0-a0df-83fd524951e7"));
    ...
    public static final EntityProxy.Concept EL_PLUS_PLUS_INFERRED_TERMINOLOGICAL_AXIOMS =
            EntityProxy.Concept.make("EL++ Inferred terminological axioms (SOLOR)", PublicIds.of("b6d3be7d-1d7f-5c44-a425-5357f878c212"));
    ...
    public static final EntityProxy.Concept EL_PLUS_PLUS_STATED_TERMINOLOGICAL_AXIOMS =
            EntityProxy.Concept.make("EL++ Stated terminological axioms (SOLOR)", PublicIds.of("1412bd09-eb0c-5107-9756-10c1c417d385"));
    ...
    public static final EntityProxy.Concept EL_PLUS_PLUS_TERMINOLOGICAL_AXIOMS =
            EntityProxy.Concept.make("EL++ terminological axioms (SOLOR)", PublicIds.of("b3ec50c4-e8cf-4720-b192-31374705f3b7"));
    ...
    public static final EntityProxy.Concept ENGLISH_DIALECT_ASSEMBLAGE =
            EntityProxy.Concept.make("English dialect assemblage (SOLOR)", PublicIds.of("c0836284-f631-3c86-8cfc-56a67814efab"));
    ...
    public static final EntityProxy.Concept ENGLISH_LANGUAGE =
            EntityProxy.Concept.make("English language (SOLOR)", PublicIds.of("02018e5a-46ba-5297-92f1-6931b9f98a12", "06d905ea-c647-3af9-bfe5-2514e135b558", "45021920-9567-11e5-8994-feff819cdc9f"));
    ...
    public static final EntityProxy.Concept EXAMPLE_UCUM_UNITS =
            EntityProxy.Concept.make("Example UCUM Units", PublicIds.of("80cd4978-314d-46e3-bc13-9980280ae955"));
    ...
    public static final EntityProxy.Concept EXPRESS_AXIOM_SYNTAX =
            EntityProxy.Concept.make("Express axiom syntax (SOLOR)", PublicIds.of("db55557c-e9ee-4504-aae3-df695b6d6c57"));
    ...
    public static final EntityProxy.Concept FIELD_SUBSTITUTION =
            EntityProxy.Concept.make("Field substitution (SOLOR)", PublicIds.of("8fdce1aa-ca82-5abc-8cfa-230c14688abc"));

    /** {@code Float field (SOLOR)} — same identity as {@code TinkarTerm.FLOAT_FIELD}. */
    public static final EntityProxy.Concept FLOAT_FIELD =
            EntityProxy.Concept.make("Float field (SOLOR)", PublicIds.of("6efe7087-3e3c-5b45-8109-90d7652b1506"));
    ...
    public static final EntityProxy.Concept FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE =
            EntityProxy.Concept.make("Fully qualified name description type (SOLOR)", PublicIds.of("00791270-77c9-32b6-b34f-d932569bd2bf", "5e1fe940-8faf-11db-b606-0800200c9a66"));
    ...
    public static final EntityProxy.Pattern GB_DIALECT_PATTERN =
            EntityProxy.Pattern.make("GB English dialect", PublicIds.of("561f817a-130e-5e56-984d-910e9991558c"));
    ...
    public static final EntityProxy.Concept GB_ENGLISH_DIALECT =
            EntityProxy.Concept.make("GB English dialect (SOLOR)", PublicIds.of("eb9a5e42-3cba-356d-b623-3ed472e20b30"));

    /** {@code Grouping (SOLOR)} — same identity as {@code TinkarTerm.GROUPING}. */
    public static final EntityProxy.Concept GROUPING =
            EntityProxy.Concept.make("Grouping (SOLOR)", PublicIds.of("8d76ead7-6c75-5d25-84d4-ca76d928f8a6"));
    ...
    public static final EntityProxy.Pattern IDENTIFIER_PATTERN =
            EntityProxy.Pattern.make("Identifier Pattern", PublicIds.of("5d60e14b-c410-5172-9559-3c4253278ae2"));
    ...
    public static final EntityProxy.Concept IDENTIFIER_SOURCE =
            EntityProxy.Concept.make("Identifier source (SOLOR)", PublicIds.of("5a87935c-d654-548f-82a2-0c06e3801162"));
    ...
    public static final EntityProxy.Concept IDENTIFIER_VALUE =
            EntityProxy.Concept.make("Identifier Value", PublicIds.of("b32dd26b-c3fc-487e-987e-16ace71a0d0f"));
    ...
    public static final EntityProxy.Concept IMMUTABLECOORDINATE_PROPERTIES =
            EntityProxy.Concept.make("ImmutableCoordinate properties (SOLOR)", PublicIds.of("ab41a788-8a83-5452-8dc0-2d8375e0bfe6"));
    ...
    public static final EntityProxy.Concept INFERRED_DEFINITION =
            EntityProxy.Concept.make("Inferred Definition", PublicIds.of("b1abf4dc-9838-4b46-ac55-10c4f92ba10b"));
    ...
    public static final EntityProxy.Concept INSTANT_LITERAL =
            EntityProxy.Concept.make("Instant literal (SOLOR)", PublicIds.of("1fbf42e2-42b7-591f-b7fd-ba5de659529e"));
    ...
    public static final EntityProxy.Concept INTEGER_FIELD =
            EntityProxy.Concept.make("Integer field (SOLOR)", PublicIds.of("ff59c300-9c4e-5e77-a35d-6a133eb3440f"));

    /** {@code Is-a (SOLOR)} — same identity as {@code TinkarTerm.IS_A}. */
    public static final EntityProxy.Concept IS_A =
            EntityProxy.Concept.make("Is-a (SOLOR)", PublicIds.of("c93a30b9-ba77-3adb-a9b8-4589c9f8fb25", "46bccdc4-8fb6-11db-b606-0800200c9a66"));
    ...
    public static final EntityProxy.Pattern KOMET_BASE_MODEL_COMPONENT_PATTERN =
            EntityProxy.Pattern.make("Komet base model component pattern", PublicIds.of("bbbbf1fe-00f0-55e0-a19c-6300dbaab9b2"));
    ...
    public static final EntityProxy.Concept KOREAN_DIALECT =
            EntityProxy.Concept.make("Korean dialect (SOLOR)", PublicIds.of("6fb2eb9c-fb9e-5959-802c-fb17bcba3079"));

    /** {@code Language (SOLOR)} — same identity as {@code TinkarTerm.LANGUAGE}. */
    public static final EntityProxy.Concept LANGUAGE =
            EntityProxy.Concept.make("Language (SOLOR)", PublicIds.of("f56fa231-10f9-5e7f-a86d-a1d61b5b56e3"));
    ...
    public static final EntityProxy.Concept LANGUAGE_CONCEPT_NID_FOR_DESCRIPTION =
            EntityProxy.Concept.make("Language concept nid for description (SOLOR)", PublicIds.of("cd56cceb-8507-5ae5-a928-16079fe6f832"));
    ...
    public static final EntityProxy.Concept LANGUAGE_COORDINATE_PROPERTIES =
            EntityProxy.Concept.make("Language coordinate properties (SOLOR)", PublicIds.of("ea1a52f7-0305-5487-8766-e846330f167a"));
    ...
    public static final EntityProxy.Concept LITERAL_VALUE =
            EntityProxy.Concept.make("Literal value (SOLOR)", PublicIds.of("208a40a7-e615-5efa-9de0-2e2a5a8488b7"));
    ...
    public static final EntityProxy.Concept LOGIC_COORDINATE_PROPERTIES =
            EntityProxy.Concept.make("Logic coordinate properties (SOLOR)", PublicIds.of("1fa63819-5ac1-5938-95b1-47871a5f2b17"));

    /** {@code long (SOLOR)} — same identity as {@code TinkarTerm.LONG}. */
    public static final EntityProxy.Concept LONG =
            EntityProxy.Concept.make("long (SOLOR)", PublicIds.of("dea8cdf1-de75-5991-9791-79714e4a964d"));
    ...
    public static final EntityProxy.Concept MAXIMUM_VALUE_OPERATOR =
            EntityProxy.Concept.make("Maximum Value Operator", PublicIds.of("7b8916ab-fd50-41df-8fc2-0b2a7a78be6d"));

    /** {@code Meaning (SOLOR)} — same identity as {@code TinkarTerm.MEANING}. */
    public static final EntityProxy.Concept MEANING =
            EntityProxy.Concept.make("Meaning (SOLOR)", PublicIds.of("a06158ff-e08a-5d7d-bcfa-6cbfdb138910"));
    ...
    public static final EntityProxy.Concept MEMBERSHIP_SEMANTIC =
            EntityProxy.Concept.make("Membership semantic (SOLOR)", PublicIds.of("4fa29287-a80e-5f83-abab-4b587973e7b7"));
    ...
    public static final EntityProxy.Concept MINIMUM_VALUE_OPERATOR =
            EntityProxy.Concept.make("Minimum Value Operator", PublicIds.of("ded98e42-f74a-4432-9ae7-01b94dc2fdea"));
    ...
    public static final EntityProxy.Concept MODEL_CONCEPT =
            EntityProxy.Concept.make("Model concept (SOLOR)", PublicIds.of("7bbd4210-381c-11e7-9598-0800200c9a66"));

    /** {@code Module (SOLOR)} — same identity as {@code TinkarTerm.MODULE}. */
    public static final EntityProxy.Concept MODULE =
            EntityProxy.Concept.make("Module (SOLOR)", PublicIds.of("40d1c869-b509-32f8-b735-836eac577a67"));
    ...
    public static final EntityProxy.Concept MODULE_FOR_VERSION =
            EntityProxy.Concept.make("Module for version (SOLOR)", PublicIds.of("67cd64f1-96d7-5110-b847-556c055ac063"));
    ...
    public static final EntityProxy.Concept MODULE_ORIGINS =
            EntityProxy.Concept.make("Module origins (SOLOR)", PublicIds.of("462862d4-5df9-426e-b785-a1264e24769f"));

    /** {@code Navigation (SOLOR)} — same identity as {@code TinkarTerm.NAVIGATION}. */
    public static final EntityProxy.Concept NAVIGATION =
            EntityProxy.Concept.make("Navigation (SOLOR)", PublicIds.of("4d9707d8-adf0-5b15-89fc-039e4ff6fec8"));

    /** {@code Object (SOLOR)} — same identity as {@code TinkarTerm.OBJECT}. */
    public static final EntityProxy.Concept OBJECT =
            EntityProxy.Concept.make("Object (SOLOR)", PublicIds.of("72765109-6b53-3814-9b05-34ebddd16592"));
    ...
    public static final EntityProxy.Concept OBJECT_PROPERTIES =
            EntityProxy.Concept.make("Object properties (SOLOR)", PublicIds.of("3ef4311c-70c0-5149-9e06-53d745f85b15"));

    /** {@code Path (SOLOR)} — same identity as {@code TinkarTerm.PATH}. */
    public static final EntityProxy.Concept PATH =
            EntityProxy.Concept.make("Path (SOLOR)", PublicIds.of("4459d8cf-5a6f-3952-9458-6d64324b27b7"));
    ...
    public static final EntityProxy.Pattern PATHS_PATTERN =
            EntityProxy.Pattern.make("Version control path pattern", PublicIds.of("add1db57-72fe-53c8-a528-1614bda20ec6"));
    ...
    public static final EntityProxy.Concept PATH_CONCEPT =
            EntityProxy.Concept.make("Path concept (SOLOR)", PublicIds.of("1b9d9f95-fc0a-55ac-b2e6-7c8b37660046"));
    ...
    public static final EntityProxy.Concept PATH_COORDINATE_PROPERTIES =
            EntityProxy.Concept.make("Path coordinate properties (SOLOR)", PublicIds.of("ec41e427-f009-5e45-a643-6dc658d63d83"));
    ...
    public static final EntityProxy.Concept PATH_FOR_VERSION =
            EntityProxy.Concept.make("Path for version (SOLOR)", PublicIds.of("ad3dd2dd-ddb0-584c-bea4-c6d9b91d461f"));
    ...
    public static final EntityProxy.Concept PATH_ORIGINS =
            EntityProxy.Concept.make("Path origins (SOLOR)", PublicIds.of("6e6a112e-7d8c-53c7-aaf1-c46e2d69743c"));
    ...
    public static final EntityProxy.Pattern PATH_ORIGINS_PATTERN =
            EntityProxy.Pattern.make("Version control path origin pattern", PublicIds.of("70f89dd5-2cdb-59bb-bbaa-98527513547c"));

    /** {@code Phenomenon (SOLOR)} — same identity as {@code TinkarTerm.PHENOMENON}. */
    public static final EntityProxy.Concept PHENOMENON =
            EntityProxy.Concept.make("Phenomenon (SOLOR)", PublicIds.of("c2e8bc47-3353-5e02-b0d1-2a5916efed4d"));

    /** {@code Preferred (SOLOR)} — same identity as {@code TinkarTerm.PREFERRED}. */
    public static final EntityProxy.Concept PREFERRED =
            EntityProxy.Concept.make("Preferred (SOLOR)", PublicIds.of("266f1bc3-3361-39f3-bffe-69db9daea56e"));
    ...
    public static final EntityProxy.Concept PRIMORDIAL_PATH =
            EntityProxy.Concept.make("Primordial path (SOLOR)", PublicIds.of("e95b6718-f824-5540-817b-8e79544eb97a"));

    /** {@code Purpose (SOLOR)} — same identity as {@code TinkarTerm.PURPOSE}. */
    public static final EntityProxy.Concept PURPOSE =
            EntityProxy.Concept.make("Purpose (SOLOR)", PublicIds.of("c3dffc48-6493-54df-a2f0-14be8ba03091"));
    ...
    public static final EntityProxy.Concept QUERY_CLAUSES =
            EntityProxy.Concept.make("Query clauses (SOLOR)", PublicIds.of("4905348c-ba1d-58ae-821f-52877d9acee3"));
    ...
    public static final EntityProxy.Concept REFERENCE_RANGE =
            EntityProxy.Concept.make("Reference Range", PublicIds.of("87ce975b-309b-47f4-a6c6-4ae6df6649a1"));
    ...
    public static final EntityProxy.Concept REFERENCE_RANGE_MAXIMUM =
            EntityProxy.Concept.make("Reference Range Maximum", PublicIds.of("72d58983-b1e1-4ca9-833f-0e40c1defd39"));
    ...
    public static final EntityProxy.Concept REFERENCE_RANGE_MINIMUM =
            EntityProxy.Concept.make("Reference Range Minimum", PublicIds.of("37c35a88-9e27-42ca-b626-186773c4b612"));
    ...
    public static final EntityProxy.Concept REGULAR_NAME_DESCRIPTION_TYPE =
            EntityProxy.Concept.make("Regular name description type (SOLOR)", PublicIds.of("8bfba944-3965-3946-9bcb-1e80a5da63a2", "d6fad981-7df6-3388-94d8-238cc0465a79"));
    ...
    public static final EntityProxy.Concept RELATIONSHIP_DESTINATION =
            EntityProxy.Concept.make("Relationship destination (SOLOR)", PublicIds.of("a3dd69af-355c-54ce-ba13-2902a7ae9551"));
    ...
    public static final EntityProxy.Concept RELATIONSHIP_ORIGIN =
            EntityProxy.Concept.make("Relationship origin (SOLOR)", PublicIds.of("ad22d43b-3ee7-550b-9660-a6e68af347c2"));

    /** {@code Role (SOLOR)} — same identity as {@code TinkarTerm.ROLE}. */
    public static final EntityProxy.Concept ROLE =
            EntityProxy.Concept.make("Role (SOLOR)", PublicIds.of("46ae9325-dd24-5008-8fda-80cf1f0977c7"));

    /** {@code Role group (SOLOR)} — same identity as {@code TinkarTerm.ROLE_GROUP}. */
    public static final EntityProxy.Concept ROLE_GROUP =
            EntityProxy.Concept.make("Role group (SOLOR)", PublicIds.of("a63f4bf2-a040-11e5-8994-feff819cdc9f", "f97abff6-a221-57a1-9cd6-e79e723bfe2a", "051fbfed-3c40-3130-8c09-889cb7b7b5b6"));
    ...
    public static final EntityProxy.Concept ROLE_OPERATOR =
            EntityProxy.Concept.make("Role operator (SOLOR)", PublicIds.of("f9860cb8-a7c7-5743-9d7c-ffc6e8a24a0f"));

    /** {@code Role type (SOLOR)} — same identity as {@code TinkarTerm.ROLE_TYPE}. */
    public static final EntityProxy.Concept ROLE_TYPE =
            EntityProxy.Concept.make("Role type (SOLOR)", PublicIds.of("76320274-be2a-5ba0-b3e8-e6d2e383ee6a"));

    /** {@code Root vertex} — same identity as {@code TinkarTerm.ROOT_VERTEX}. */
    public static final EntityProxy.Concept ROOT_VERTEX =
            EntityProxy.Concept.make("Root vertex", PublicIds.of("7c21b6c5-cf11-5af9-893b-743f004c97f5"));
    ...
    public static final EntityProxy.Concept SANDBOX_COMPONENT =
            EntityProxy.Concept.make("Sandbox component (SOLOR)", PublicIds.of("c93829b2-aa78-5a84-ac9a-c34307844166"));
    ...
    public static final EntityProxy.Concept SANDBOX_MODULE =
            EntityProxy.Concept.make("Sandbox module (SOLOR)", PublicIds.of("c5daf0e9-30dc-5b3e-a521-d6e6e72c8a95"));
    ...
    public static final EntityProxy.Concept SANDBOX_PATH =
            EntityProxy.Concept.make("Sandbox path (SOLOR)", PublicIds.of("80710ea6-983c-5fa0-8908-e479f1f03ea9"));
    ...
    public static final EntityProxy.Concept SEMANTIC_FIELD_TYPE =
            EntityProxy.Concept.make("Semantic field type (SOLOR)", PublicIds.of("9c3dfc88-51e4-5e51-a59a-88dd580162b7"));
    ...
    public static final EntityProxy.Concept SEMANTIC_PROPERTIES =
            EntityProxy.Concept.make("Semantic properties (SOLOR)", PublicIds.of("b717ae48-5488-5dda-a980-97855001cc99"));
    ...
    public static final EntityProxy.Concept SEMANTIC_TYPE =
            EntityProxy.Concept.make("Semantic type (SOLOR)", PublicIds.of("3daac6c4-78c5-5271-9c63-6e28f80e0c52"));
    ...
    public static final EntityProxy.Concept STARTER_DATA_AUTHORING =
            EntityProxy.Concept.make("Starter Data Authoring (SOLOR)", PublicIds.of("070deb74-acc5-46bf-b9c6-eaee1b58ef52"));
    ...
    public static final EntityProxy.Concept STATED_DEFINITION =
            EntityProxy.Concept.make("Stated Definition", PublicIds.of("28608bd3-ac73-4fe8-a5f0-1efe0d6650a8"));
    ...
    public static final EntityProxy.Concept STATUS_FOR_VERSION =
            EntityProxy.Concept.make("Status for version (SOLOR)", PublicIds.of("0608e233-d79d-5076-985b-9b1ea4e14b4c"));
    ...
    public static final EntityProxy.Concept STATUS_VALUE =
            EntityProxy.Concept.make("Status value (SOLOR)", PublicIds.of("10b873e2-8247-5ab5-9dec-4edef37fc219"));

    /** {@code String (SOLOR)} — same identity as {@code TinkarTerm.STRING}. */
    public static final EntityProxy.Concept STRING =
            EntityProxy.Concept.make("String (SOLOR)", PublicIds.of("a46aaf11-b37a-32d6-abdc-707f084ec8f5"));
    ...
    public static final EntityProxy.Concept SUFFICIENT_CONCEPT_DEFINITION_OPERATOR =
            EntityProxy.Concept.make("Sufficient concept definition operator (SOLOR)", PublicIds.of("dfa80f36-dbe6-5006-8509-c497a26ceab5"));
    ...
    public static final EntityProxy.Concept TAXONOMY_OPERATOR =
            EntityProxy.Concept.make("Taxonomy operator (SOLOR)", PublicIds.of("e9252365-7a43-57ea-bf94-3f23bab4ef99"));
    ...
    public static final EntityProxy.Concept TEXT_COMPARISON_MEASURE_SEMANTIC =
            EntityProxy.Concept.make("Text comparison measure semantic (SOLOR)", PublicIds.of("b1531e68-4e7a-5194-b1f9-9aaace269372"));
    ...
    public static final EntityProxy.Concept TEXT_FOR_DESCRIPTION =
            EntityProxy.Concept.make("Text for description (SOLOR)", PublicIds.of("8bdcbe5d-e92e-5c10-845e-b585e6061672"));
    ...
    public static final EntityProxy.Concept TIME_FOR_VERSION =
            EntityProxy.Concept.make("Time for version (SOLOR)", PublicIds.of("a9b0dfb2-f463-5dae-8ba8-7f2e8385571b"));
    ...
    public static final EntityProxy.Pattern TINKAR_BASE_MODEL_COMPONENT_PATTERN =
            EntityProxy.Pattern.make("Tinkar base model component pattern", PublicIds.of("6070f6f5-893d-5144-adce-7d305c391cf9"));
    ...
    public static final EntityProxy.Concept TINKAR_MODEL_CONCEPT =
            EntityProxy.Concept.make("Tinkar Model concept (SOLOR)", PublicIds.of("bc59d656-83d3-47d8-9507-0e656ea95463"));
    ...
    public static final EntityProxy.Concept TREE_AMALGAM_PROPERTIES =
            EntityProxy.Concept.make("Tree amalgam properties (SOLOR)", PublicIds.of("d6151a47-4610-5a5c-abd0-42c82be9b633"));
    ...
    public static final EntityProxy.Concept UNINITIALIZED_COMPONENT =
            EntityProxy.Concept.make("Uninitialized component (SOLOR)", PublicIds.of("55f74246-0a25-57ac-9473-a788d08fb656"));
    ...
    public static final EntityProxy.Concept UNIVERSALLY_UNIQUE_IDENTIFIER =
            EntityProxy.Concept.make("Universally Unique Identifier (SOLOR)", PublicIds.of("845274b5-9644-3799-94c6-e0ea37e7d1a4"));

    /** {@code User (SOLOR)} — same identity as {@code TinkarTerm.USER}. */
    public static final EntityProxy.Concept USER =
            EntityProxy.Concept.make("User (SOLOR)", PublicIds.of("f7495b58-6630-3499-a44e-2052b5fcf06c"));
    ...
    public static final EntityProxy.Pattern US_DIALECT_PATTERN =
            EntityProxy.Pattern.make("US Dialect pattern", PublicIds.of("08f9112c-c041-56d3-b89b-63258f070074"));
    ...
    public static final EntityProxy.Concept US_ENGLISH_DIALECT =
            EntityProxy.Concept.make("US English dialect (SOLOR)", PublicIds.of("bca0a686-3516-3daf-8fcf-fe396d13cfad"));
    ...
    public static final EntityProxy.Concept VALUE_CONSTRAINT =
            EntityProxy.Concept.make("Value Constraint", PublicIds.of("8c55fb86-92d8-42a9-ad70-1e23abbf7eec"));
    ...
    public static final EntityProxy.Concept VALUE_CONSTRAINT_SOURCE =
            EntityProxy.Concept.make("Value Constraint Source", PublicIds.of("09aa031a-6290-4ec9-a44c-23928a767da3"));
    ...
    public static final EntityProxy.Concept VERSION_PROPERTIES =
            EntityProxy.Concept.make("Version properties (SOLOR)", PublicIds.of("93f844df-38e5-5167-ba94-2c948b8bd07c"));
