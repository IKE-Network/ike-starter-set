...
final class Section35 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Concept focus (SOLOR)", PublicIds.of("dca9854d-9e4c-5e8a-8b30-6c1af6901bb8")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("70a95faa-822f-4098-904c-c2e0cef24ba6"), IkeTerm.ENGLISH_LANGUAGE, "The component-type focus selecting concepts: an action or rule scoped to concept components.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Description focus (SOLOR)", PublicIds.of("6edf734d-7f57-5430-9164-6ee0824fd94b")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("abf0aa8d-427b-4e7e-9484-0717aa1d2622"), IkeTerm.ENGLISH_LANGUAGE, "The component-type focus selecting descriptions: an action or rule scoped to description components.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
