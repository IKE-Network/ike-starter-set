...
final class Section7 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("IKE base model concept", PublicIds.of(UUID.fromString("bc59d656-83d3-47d8-9507-0e656ea95463"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("04f9eada-89fa-4c54-ac2f-3697c1bd937a")), IkeTerm.ENGLISH_LANGUAGE, "IKE base model concept", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("f68dbfb0-d8d2-465c-8cb0-5088da74144f")), IkeTerm.ENGLISH_LANGUAGE, "IKE base model concept", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                // Definition text diverges from the baseline artifact: one-rigorous-term revision in place (IKE-Network/ike-issues#893, #894).
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("06d1eb76-87b4-440a-98c1-d0037f76a936")), IkeTerm.ENGLISH_LANGUAGE, "Root of the base model's own terminology: the concepts the base model uses to describe itself — components, descriptions, dialects, fields, and axioms — rather than any modeled domain.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
