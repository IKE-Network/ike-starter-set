...
final class Section39 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Inferred premise type (SOLOR)", PublicIds.of(UUID.fromString("a4c6bf72-8fb6-11db-b606-0800200c9a66"), UUID.fromString("1290e6ba-48d0-31d2-8d62-e133373c63f5"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("2049c4a3-cef5-489b-ad58-8630908007c9")), IkeTerm.ENGLISH_LANGUAGE, "Inferred", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
