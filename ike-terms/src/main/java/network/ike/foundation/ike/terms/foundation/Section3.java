...
final class Section3 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Description logic profile for logic coordinate (SOLOR)", PublicIds.of("aef80e34-b2dd-5dca-a989-3e0ee2699be3")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("2f7cc64f-81f8-4626-a93f-0157c258b3c0"), IkeTerm.ENGLISH_LANGUAGE, "The logic-coordinate dimension naming the description-logic profile whose expressivity the reasoner assumes when classifying; this set's profile is EL++.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Destination module for edit coordinate (SOLOR)", PublicIds.of("349cfd1d-10fd-5f8d-a0a5-d5ef0932b4da")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("4f31cf3d-b20a-4a0d-9d53-38181dd8aa9a"), IkeTerm.ENGLISH_LANGUAGE, "The edit-coordinate dimension naming the module a moved or promoted version lands in, as distinct from the default module new edits are stamped with.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
