...
final class Section3 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("ImmutableCoordinate Properties (SOLOR)", PublicIds.of("ab41a788-8a83-5452-8dc0-2d8375e0bfe6")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("fc46591a-e6a9-4d60-9968-353311f0e5f9"), IkeTerm.ENGLISH_LANGUAGE, "Groups the dimension concepts every coordinate kind is assembled from -- stamp, language, logic, path, edit, and navigation -- named individually so a view's configuration is itself describable knowledge. Coordinates are immutable: a changed dimension yields a new coordinate, never a mutated one.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Modules for stamp coordinate (SOLOR)", PublicIds.of("bf69c4f1-95c9-5956-a10a-d3ba9276c019")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("19d1fa35-3e6b-4a0b-a030-3668df021b01"), IkeTerm.ENGLISH_LANGUAGE, "The stamp-coordinate dimension holding the modules a view accepts versions from.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Language specification for language coordinate (SOLOR)", PublicIds.of("b0ad4d77-e1bc-5fd1-922e-5fad675e9bfd")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("de33982e-2e19-4a39-aeac-d8358efd947b"), IkeTerm.ENGLISH_LANGUAGE, "The language-coordinate dimension carrying the coordinate's full language specification as one value: language plus dialect and description-type preferences.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Module preference order for stamp coordinate (SOLOR)", PublicIds.of("ddeda759-e89c-5186-aa40-d63070756ab4")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("c854d995-8099-40a8-899c-7fe91193de04"), IkeTerm.ENGLISH_LANGUAGE, "The stamp-coordinate dimension ranking acceptable modules: when versions tie across modules, the earlier module in this order wins.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Module preference list for language coordinate (SOLOR)", PublicIds.of("f36e7ca6-34a2-58b5-8b25-736457515f9c")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("f6203935-93ee-4094-a80f-39e04e1a5816"), IkeTerm.ENGLISH_LANGUAGE, "The language-coordinate dimension holding modules in preference order, for choosing among descriptions that differ only by module.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Description logic profile for logic coordinate (SOLOR)", PublicIds.of("aef80e34-b2dd-5dca-a989-3e0ee2699be3")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("2f7cc64f-81f8-4626-a93f-0157c258b3c0"), IkeTerm.ENGLISH_LANGUAGE, "The logic-coordinate dimension naming which description-logic profile the reasoner assumes: the coordinate slot whose value is a profile such as EL++ logic profile, as distinct from the profile family itself.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Stated pattern for logic coordinate", PublicIds.of("cfd2a47e-8169-5e71-9122-d5b73efd990a")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("a6d8c1a3-1bb6-4534-ab22-588f0477c1c1"), IkeTerm.ENGLISH_LANGUAGE, "Stated pattern", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
        ...
        set.concept("Path options for edit coordinate (SOLOR)", PublicIds.of("2110c10c-9174-55aa-8ffe-91650c77d0b3")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("a8f3145c-b6c2-4924-96a2-b5bce7a1a03c"), IkeTerm.ENGLISH_LANGUAGE, "The edit-coordinate dimension listing the paths an editor may choose to commit on.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Classifier for logic coordinate (SOLOR)", PublicIds.of("4b90e89d-2a0e-5ca3-8ae5-7498d148a9d2")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("20b76fdc-4641-4ced-bea9-1eb861e9ab38"), IkeTerm.ENGLISH_LANGUAGE, "The logic-coordinate dimension naming which reasoner owns the inferred content a view resolves; inferred semantics are stamped with the classifier as their author.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Default module for edit coordinate (SOLOR)", PublicIds.of("e83d322c-e275-5392-a5db-1de5fe98acb5")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("c0a9a6ad-0d1f-4c6c-89c2-d79db1e02c13"), IkeTerm.ENGLISH_LANGUAGE, "The edit-coordinate dimension naming the module a new edit is stamped with, unless the editor chooses another from the options.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Vertex state set (SOLOR)", PublicIds.of("347cd3f2-8130-5032-8960-091e194e9afe")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("90766a0c-0973-48a3-bbc4-2f3a1ff90cff"), IkeTerm.ENGLISH_LANGUAGE, "The navigation-coordinate dimension holding the states a component must be in to appear in navigation; active-only in the default view.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Vertex sort (SOLOR)", PublicIds.of("e973f077-a99d-59e6-b7bd-804e87e0e639")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("b107a6fa-e0aa-41e7-bdf0-6a8f98174e55"), IkeTerm.ENGLISH_LANGUAGE, "The navigation-coordinate dimension naming the sort applied to a vertex's children when a navigator renders them.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Module preference list for stamp coordinate (SOLOR)", PublicIds.of("f56ef2df-6758-5271-a587-317a4fed6c2e")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("985701b3-c38c-485c-a1bd-fc234a47b419"), IkeTerm.ENGLISH_LANGUAGE, "The stamp-coordinate dimension listing the modules a view accepts; together with the exclusion set it makes module scoping affirmative.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Module options for edit coordinate (SOLOR)", PublicIds.of("19305aff-95d9-55d9-b015-825cc68eadc7")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("726a193a-05dc-4a50-9ef5-93cf5aed7834"), IkeTerm.ENGLISH_LANGUAGE, "The edit-coordinate dimension listing the modules an editor may choose to commit into.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Root for logic coordinate (SOLOR)", PublicIds.of("862cc189-bbcb-51a0-89a4-16e1854be247")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("13ae278e-7d3c-4fd0-89d1-6d0b8b2b3275"), IkeTerm.ENGLISH_LANGUAGE, "The logic-coordinate dimension naming the taxonomy root a classification is computed beneath.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Module exclusion set for stamp coordinate (SOLOR)", PublicIds.of("3fe047f0-33b0-5254-91c2-43e65f90d30b")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("0a9d9d25-9eab-47dc-9579-d872a52280d7"), IkeTerm.ENGLISH_LANGUAGE, "The stamp-coordinate dimension holding modules to ignore outright: a version in an excluded module is invisible to the view regardless of any preference order.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Language nid for language coordinate (SOLOR)", PublicIds.of("38e0c7b8-1e33-56a2-9eb2-ee20c4960684")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("8cc3a5dc-d146-4257-a80c-c38befffb33c"), IkeTerm.ENGLISH_LANGUAGE, "The language-coordinate dimension naming the language whose descriptions the coordinate selects.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Path for path coordinate (SOLOR)", PublicIds.of("748e073c-fea7-58dd-8aa3-f18fdd82ddfc")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("b14b535b-4f4f-4963-beba-5ee8e8df8e2d"), IkeTerm.ENGLISH_LANGUAGE, "The path-coordinate dimension naming the version-control path a position sits on; with a time, it is the coordinate's complete position.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Inferred pattern for logic coordinate", PublicIds.of("9ecf4d76-4346-5e5d-8316-bdff48a5c154")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("5c54a52b-f269-4f60-90fc-540dd5e957f3"), IkeTerm.ENGLISH_LANGUAGE, "Inferred pattern", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
        ...
        set.concept("Description type preference list for language coordinate (SOLOR)", PublicIds.of("44c7eab6-fdb8-5427-9d7a-52ab63f7a6f9")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("a3c1c82c-d690-4cdf-947d-c81971023109"), IkeTerm.ENGLISH_LANGUAGE, "The language-coordinate dimension holding description types in preference order: which type a surface renders first when a component carries several.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Position on path (SOLOR)", PublicIds.of("31173582-a49d-51c6-813f-f42d0976aaea")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("430aaf8f-bc98-4e15-882c-459a20d3f232"), IkeTerm.ENGLISH_LANGUAGE, "A position: a path plus a time on it, the point a stamp coordinate resolves latest against.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Path origins for stamp path (SOLOR)", PublicIds.of("f33e1668-34dd-53dd-8728-31b29934b482")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("af7153cc-fac6-46b1-80a0-6ddfe828855f"), IkeTerm.ENGLISH_LANGUAGE, "The record of which path a path branched from, and when: each origin is a position up to which the origin path's versions are visible from the branching path.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Destination module for edit coordinate (SOLOR)", PublicIds.of("349cfd1d-10fd-5f8d-a0a5-d5ef0932b4da")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("4f31cf3d-b20a-4a0d-9d53-38181dd8aa9a"), IkeTerm.ENGLISH_LANGUAGE, "The edit-coordinate dimension naming the module a moved or promoted version lands in -- the target of a transfer, as distinct from the default module new edits are stamped with and the options an editor may choose among.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
