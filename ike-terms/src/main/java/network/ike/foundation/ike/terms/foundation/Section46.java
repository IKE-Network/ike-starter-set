...
final class Section46 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Annotation type (SOLOR)", PublicIds.of("3fe77951-58c9-51b3-8e7e-65edcf7ace0a")).at(inception)
                ...
                .statedAxioms(PublicIds.of("c5cac924-73bc-575b-9878-2420bbb614b9"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.ROOT_VERTEX))))
        ...
        set.concept("Komet issue (SOLOR)", PublicIds.of("e1dd7bf2-224d-53a5-a5fb-7b25b05d17a6")).at(inception)
                ...
                .statedAxioms(PublicIds.of("4184d783-0736-51da-9bf5-21f48c015265"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.ANNOTATION_TYPE))))
        ...
        set.concept("Comment (SOLOR)", PublicIds.of("147832d4-b9b8-5062-8891-19f9c4e4760a")).at(inception)
                ...
                .statedAxioms(PublicIds.of("e7be0c75-a4eb-5e4a-bec8-947cd92f5d2c"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.ANNOTATION_TYPE))))
