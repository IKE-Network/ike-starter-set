...
final class Section46 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Annotation type (SOLOR)", PublicIds.of(UUID.fromString("3fe77951-58c9-51b3-8e7e-65edcf7ace0a"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("b37b7688-0d3f-4821-a2d7-d104e6002c2c")), IkeTerm.ENGLISH_LANGUAGE, "The model family for annotation kinds — metadata attached to components, defining the structure such annotations take, rather than content in its own right. A model concept, not domain content.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
