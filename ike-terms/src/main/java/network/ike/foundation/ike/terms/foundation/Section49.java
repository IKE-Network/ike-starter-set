...
final class Section49 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Annotation property set", PublicIds.of("cb9e33de-f82c-495d-89fa-69afecbcd47d")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("da5b80d1-b026-4416-a21e-8d023580ea9b"), IkeTerm.ENGLISH_LANGUAGE, "Annotation property set (SOLOR)", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("d00a01be-fc68-5e82-af39-0b4cb2893e4f"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.OBJECT_PROPERTIES))))
