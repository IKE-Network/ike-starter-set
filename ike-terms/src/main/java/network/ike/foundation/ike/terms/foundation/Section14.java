...
final class Section14 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Concrete value operator (SOLOR)", PublicIds.of("843b0b55-8785-5544-93f6-581da9cf1ff3")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("d885dabc-d314-4993-b171-7f0feba98c81"), IkeTerm.ENGLISH_LANGUAGE, "Groups the comparison operators a concrete-domain axiom uses to relate a measured quantity to a literal bound: equal, less than, greater than, and their inclusive forms.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Less than or equal to (SOLOR)", PublicIds.of("6dfacbd5-8344-5794-9fda-bec95b2aa6c9")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("d361fd77-3753-4a3a-8755-180df64ab362"), IkeTerm.ENGLISH_LANGUAGE, "The concrete-domain operator asserting that a value is at most the stated bound.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Less than (SOLOR)", PublicIds.of("6f96e8cf-5568-5e49-8a90-aa6c65125ee9")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("ab7004b7-d20a-4d3a-80eb-6da33801a535"), IkeTerm.ENGLISH_LANGUAGE, "The concrete-domain operator asserting that a value is strictly below the stated bound.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Greater than or equal to (SOLOR)", PublicIds.of("c1baba19-e918-5d2c-8fa4-b0ad93e03186")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("6b15ddb8-70db-4eb4-af84-3aa659304b31"), IkeTerm.ENGLISH_LANGUAGE, "The concrete-domain operator asserting that a value is at least the stated bound.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Greater than (SOLOR)", PublicIds.of("65af466b-360c-58b2-8b7d-2854150029a8")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("893179a4-ce13-437b-8bd2-5350c3084a65"), IkeTerm.ENGLISH_LANGUAGE, "The concrete-domain operator asserting that a value is strictly above the stated bound.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Equal to (SOLOR)", PublicIds.of("5c9b5844-1434-5111-83d5-cb7cb0be12d9")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("62183df2-2e8d-4418-aea4-90c69392e7b9"), IkeTerm.ENGLISH_LANGUAGE, "The concrete-domain operator asserting that a value matches the stated one exactly.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
