...
final class Section14 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Concrete value operator (SOLOR)", PublicIds.of("843b0b55-8785-5544-93f6-581da9cf1ff3")).at(inception)
                ...
                .statedAxioms(PublicIds.of("8aa3eb09-fd9b-5265-8ca8-7a34385f9104"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.TINKAR_MODEL_CONCEPT))))
        ...
        set.concept("Minimum Value Operator (SOLOR)", PublicIds.of("ded98e42-f74a-4432-9ae7-01b94dc2fdea")).at(inception)
                ...
                .statedAxioms(PublicIds.of("6ce65e64-7299-5baa-a64a-41599a3b13f1"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.CONCRETE_DOMAIN_OPERATOR))))
        ...
        set.concept("Maximum Value Operator (SOLOR)", PublicIds.of("7b8916ab-fd50-41df-8fc2-0b2a7a78be6d")).at(inception)
                ...
                .statedAxioms(PublicIds.of("67faa3fb-2c93-5d00-8213-71f07dc9f336"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.CONCRETE_DOMAIN_OPERATOR))))
