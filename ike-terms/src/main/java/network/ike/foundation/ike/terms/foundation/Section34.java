...
final class Section34 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Value Constraint (SOLOR)", PublicIds.of("8c55fb86-92d8-42a9-ad70-1e23abbf7eec")).at(inception)
                ...
                .statedAxioms(PublicIds.of("f0b576b8-0b9c-56ee-a5ab-98a6915afb70"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.TINKAR_MODEL_CONCEPT), leb.ConceptAxiom(IkeTerm.MEANING))))
