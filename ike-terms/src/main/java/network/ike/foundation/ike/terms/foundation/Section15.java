...
final class Section15 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Stated Definition (SOLOR)", PublicIds.of("28608bd3-ac73-4fe8-a5f0-1efe0d6650a8")).at(inception)
                ...
                .statedAxioms(PublicIds.of("d4b6662b-53a8-5718-8782-a56db798cbf5"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.TINKAR_MODEL_CONCEPT), leb.ConceptAxiom(IkeTerm.MEANING))))
