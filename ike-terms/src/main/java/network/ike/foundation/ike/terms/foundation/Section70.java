...
final class Section70 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Instant field", PublicIds.of(UUID.fromString("e9bde1bc-aa72-430a-afe1-aa8aec8833b4"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("a97517f2-2eb3-4d81-b04d-a46cc6ee92d3")), IkeTerm.ENGLISH_LANGUAGE, "Instant field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("26fb7513-b75f-5d3b-a813-4911f2c7392f")))
                ;

        set.concept("String field", PublicIds.of(UUID.fromString("27d3905b-b19a-41ff-bed1-fc55f49f8ce4"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("3adf93b7-58f2-4600-80c4-b0d9c88fa0c5")), IkeTerm.ENGLISH_LANGUAGE, "String field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("68fd41fd-442e-5c39-a7e0-37c0dd47eda8")))
                ;
        ...
        set.concept("Field definition purpose field", PublicIds.of(UUID.fromString("93239959-50e6-4645-b5fc-6d47da92e666"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("320a45be-a2ca-4915-a387-7a631212001a")), IkeTerm.ENGLISH_LANGUAGE, "Field definition purpose field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
        ...
        set.concept("Upper Bound Open", PublicIds.of(UUID.fromString("c20b3b1e-112f-4cb2-b901-4046db844629"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("9eafb031-4b17-4589-bd50-ae70c5908ffb")), IkeTerm.ENGLISH_LANGUAGE, "Upper Bound Open", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("30cac71b-1115-4e0f-9ed8-a0861e5ca0d9")), IkeTerm.ENGLISH_LANGUAGE, "Upper Bound Open", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("11bf7b9c-637f-5b63-9814-48068879fb72")))
                ;

        set.concept("Integer field", PublicIds.of(UUID.fromString("db249d1f-ea2e-4608-ae13-166ed20ca825"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("4190db17-c49d-4686-9652-55c043796e94")), IkeTerm.ENGLISH_LANGUAGE, "Integer field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("29c63076-b25f-5408-965c-7197043d6f19")))
                ;
        ...
        set.concept("Concept field", PublicIds.of(UUID.fromString("ebe2aa74-f100-41b2-8d75-2d8f06ce5e4e"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("f75590d7-49e1-42fc-afb0-490b7f8236cf")), IkeTerm.ENGLISH_LANGUAGE, "Concept field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("30a298db-142e-5209-b294-dedf96d86f95")))
                ;

        set.concept("Semantic versions field", PublicIds.of(UUID.fromString("aeb73410-a679-4ea8-93fe-7c4785599778"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("0c68481a-0d59-434d-802c-a1dd8268f536")), IkeTerm.ENGLISH_LANGUAGE, "Semantic versions field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("02bd7335-4109-50d6-8539-09e2127949e3")))
                ;

        set.concept("Semantic field field", PublicIds.of(UUID.fromString("f6572c76-b5c0-41da-99c0-4344694e7e3c"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("fc5eedd2-db8b-4a1c-8375-27335d57a7bc")), IkeTerm.ENGLISH_LANGUAGE, "Semantic field field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("45395adb-9157-4710-8810-1a92b0bc1757")), IkeTerm.ENGLISH_LANGUAGE, "Semantic field field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("de300f46-a593-55b1-bb7d-194a4069b7ae")))
                ;

        set.concept("Semantic field fields set", PublicIds.of(UUID.fromString("8dcfc1a1-31f2-46f7-8247-0a17a6d7c6c0"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("9fc81e4e-ee6c-47e5-b450-8eec37c1489e")), IkeTerm.ENGLISH_LANGUAGE, "Semantic field fields set", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("20922df6-f4c5-5305-a34f-d2cfbfc9eb5c")))
                ;

        set.concept("Feature Role Type", PublicIds.of(UUID.fromString("acb8d47e-adac-491d-bc60-78e94cacd312"))).at(inception)
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("a47b9598-2805-5263-8242-553866371e31")))
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("409fe4ec-332d-4058-9c09-9d096c8a09ac")), IkeTerm.ENGLISH_LANGUAGE, "Feature Role Type", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("4296aed0-9607-464e-bb52-68eae3107a57")), IkeTerm.ENGLISH_LANGUAGE, "Feature Role Type", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                ;

        set.concept("Field value field", PublicIds.of(UUID.fromString("7e4a96fc-0522-4d74-a7d1-ca74be3bc236"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("5e9aa5cb-6888-4582-a474-38d4c63fc445")), IkeTerm.ENGLISH_LANGUAGE, "Field value field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("5564945a-baa2-5642-8d40-6138561216d5")))
                ;

        set.concept("Pattern versions set", PublicIds.of(UUID.fromString("a254ccee-ef02-4504-9645-0a2ed7af955d"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("9ff7977c-e27d-4ebb-a494-f8e01f590d61")), IkeTerm.ENGLISH_LANGUAGE, "Pattern versions set", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("a3aed4d3-7817-5675-ad9f-fe690ba6b199")))
                ;

        set.concept("Component versions set", PublicIds.of(UUID.fromString("54d670f1-234d-485a-a354-e1fa7eea1bf2"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("77cef2f7-7515-4166-a289-83e20ed8bda5")), IkeTerm.ENGLISH_LANGUAGE, "Component versions set", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("fd4de866-ae89-56e5-b54a-2023ca848d5b")))
                ;

        set.concept("Interval Set Axioms", PublicIds.of(UUID.fromString("b253e725-d7cd-46e3-bc3a-5db8b3ffbd52"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("0f689d87-b5ff-48c7-b626-deb91972b101")), IkeTerm.ENGLISH_LANGUAGE, "Interval Set Axioms", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("6ea5db6a-19ea-4aa4-b9ae-8b35ce26c039")), IkeTerm.ENGLISH_LANGUAGE, "Interval Set Axioms", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("ac63da3e-0c4a-5d86-9805-fa14a069ccb3")))
                ;
        ...
        set.concept("Interval Role Type", PublicIds.of(UUID.fromString("6fa58611-af37-402e-a0c2-6ee1d6068651"))).at(inception)
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("f349d6b6-81f6-5749-832c-2b795b2833cd")))
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("81a84029-57d2-46f2-847d-6bddbfc7d43c")), IkeTerm.ENGLISH_LANGUAGE, "Interval Role Type", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("9c9d31d2-e1df-448e-988d-94649386173d")), IkeTerm.ENGLISH_LANGUAGE, "Interval Role Type", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                ;

        set.concept("Pattern meaning field", PublicIds.of(UUID.fromString("996d0023-a355-422f-a84d-16dda6ece1b0"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("22d8038d-bbe5-4626-aa64-59d617b06ed2")), IkeTerm.ENGLISH_LANGUAGE, "Pattern meaning field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("75742c74-5b59-5069-94a3-af52a183fdb4")))
                ;
        ...
        set.concept("Public ID field", PublicIds.of(UUID.fromString("196838c5-55f4-4e40-8618-b9ce60685c2f"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("1d7c9dc9-5886-4c91-a39e-222296b7a3d3")), IkeTerm.ENGLISH_LANGUAGE, "Public ID field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("d3b567b8-599f-5a2d-8ab6-a6134e792176")))
                ;
        ...
        set.concept("Uniquely identify knowledge graph components", PublicIds.of(UUID.fromString("dde9a93d-250c-449b-bea0-ba1133d1387b"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("84995eba-4c29-4461-8c95-7cec6f4f12c0")), IkeTerm.ENGLISH_LANGUAGE, "Uniquely identify knowledge graph components", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("72282a9b-280f-5393-8cd7-4a59b0844fd9")))
                ;

        set.concept("Concept versions field", PublicIds.of(UUID.fromString("3a08b5f1-f17e-4db5-8cf9-c6540f26f241"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("67271240-9116-45a4-9622-3cbe9149d355")), IkeTerm.ENGLISH_LANGUAGE, "Concept versions field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("7b84bd4c-2e8e-5781-ab5a-3c7147359bca")))
                ;

        set.concept("Concept versions set", PublicIds.of(UUID.fromString("806c7f9f-52f9-4b53-9758-122899b28a76"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("a1bcfd86-7970-4a54-922d-adad1895e061")), IkeTerm.ENGLISH_LANGUAGE, "Concept versions set", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("b2aa911a-e94b-5da6-af9a-8ef44d99cbdc")))
                ;
        ...
        set.concept("Field definition data type field", PublicIds.of(UUID.fromString("02273b53-fce7-4cbe-921d-2cff67e81ad5"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("3f336a02-a965-470a-b4fd-dfa7ecb8f2d8")), IkeTerm.ENGLISH_LANGUAGE, "Field definition data type field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("090eb280-d300-57d0-98be-e77694d68fe1")))
                ;

        set.concept("Pattern purpose field", PublicIds.of(UUID.fromString("352c821b-7a11-454c-a127-48ad3206573d"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("18ec7dcd-fe02-4d3b-88b6-a446c5d04498")), IkeTerm.ENGLISH_LANGUAGE, "Pattern purpose field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("29d1f0d4-537a-52e8-9771-de353141fb1d")))
                ;

        set.concept("Pattern field", PublicIds.of(UUID.fromString("751790c7-e1e4-42bc-b531-54c54bd6eebd"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("1edef18a-20a1-45e9-b351-89a84649426b")), IkeTerm.ENGLISH_LANGUAGE, "Pattern field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("b2c9e0d2-0192-526e-b248-82e629525378")))
                ;

        set.concept("Pattern versions field", PublicIds.of(UUID.fromString("7b8ecbbf-55b4-41bc-acbf-51824e74446a"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("03ef1ffa-2c30-4bd8-b1d0-bb4e17e01b2b")), IkeTerm.ENGLISH_LANGUAGE, "Pattern versions field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("fc925094-e901-4192-b641-fd1061c1a203")), IkeTerm.ENGLISH_LANGUAGE, "Pattern versions field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("4be32931-498f-5dd8-8e13-090a7faa0680")))
                ;

        set.concept("Unit of Measure", PublicIds.of(UUID.fromString("40afdda5-89d6-4b80-8181-1ddd6eb92dc8"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("d39215af-3ff1-42bd-9c6a-b5a59177a8d5")), IkeTerm.ENGLISH_LANGUAGE, "Unit of Measure", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("8eae0ae5-4008-4ed0-a59a-9c079521197e")), IkeTerm.ENGLISH_LANGUAGE, "Unit of Measure", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("54928fcd-7499-54c6-84ef-c6ab311e3543")))
                ;

        set.concept("Field definitions set", PublicIds.of(UUID.fromString("975de83e-ab99-4a9e-9051-4cbf310a2123"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("7639982f-9ccf-42c4-aad1-d9743ec59e39")), IkeTerm.ENGLISH_LANGUAGE, "Field definitions set", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("9ad1de67-18e1-550d-aef9-d85ecfa6fba5")))
                ;

        set.concept("Lower Bound Open", PublicIds.of(UUID.fromString("a0096ba1-0718-4c03-ad8f-8143c44091e7"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("95c87fd6-1f02-4e52-bb1d-86b229fd5e6b")), IkeTerm.ENGLISH_LANGUAGE, "Lower Bound Open", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("92167484-69d4-4488-a2b1-169750138f85")), IkeTerm.ENGLISH_LANGUAGE, "Lower Bound Open", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("611332e4-38b7-5639-9303-92f5e84fc038")))
                ;

        set.concept("Semantic field", PublicIds.of(UUID.fromString("8b6c69d7-a5aa-4db2-bcea-8c7b2817b02f"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("d0b00d78-00df-4358-b2a3-e4b713f19a06")), IkeTerm.ENGLISH_LANGUAGE, "Semantic field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("6027de68-e80c-58b0-8032-62a5bc6f51ea")))
                ;
        ...
        set.concept("Semantic pattern field", PublicIds.of(UUID.fromString("19dd5dd3-1075-4113-a437-5f1f7c2d55bc"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("c6c8c1b3-95cc-485b-adbf-5c218cbf1241")), IkeTerm.ENGLISH_LANGUAGE, "Semantic pattern field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("9d1e6d38-030d-59d6-a6f7-bf180724cb66")))
                ;
        ...
        set.concept("Semantic referenced component field", PublicIds.of(UUID.fromString("4111ba1e-c818-4c5d-9fed-34d07298d009"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("0562f9bf-867e-47d3-bcac-c37e170df2f2")), IkeTerm.ENGLISH_LANGUAGE, "Semantic referenced component field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("f4800036-6f1d-5c09-8e0a-3410d9032dae")))
                ;

        set.concept("Semantic versions set", PublicIds.of(UUID.fromString("4fd69aed-556f-4938-94cc-ea7ea707ccef"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("05e65c46-6c96-4eff-b10a-6200991da097")), IkeTerm.ENGLISH_LANGUAGE, "Semantic versions set", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("d81283c1-cccb-5ac3-90f8-784dadca8313")))
                ;
        ...
        set.concept("Field definition meaning field", PublicIds.of(UUID.fromString("74dffbed-0bef-44a4-8ad6-8cff84fe47ae"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("1ef0b24c-239c-4e11-a11c-1cd09d3028d3")), IkeTerm.ENGLISH_LANGUAGE, "Field definition meaning field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("d3fb8cda-0d19-5c54-bf2d-a909ac5071e0")))
                ;

        set.concept("Interval Lower Bound", PublicIds.of(UUID.fromString("52b3e38a-fccb-4779-aa61-4e87abd56419"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("9f5130bd-791d-469d-b1c3-6f95ff918fd4")), IkeTerm.ENGLISH_LANGUAGE, "Interval Lower Bound", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("cfcfd411-c8bc-4b90-bec7-97dee2eb2e7c")), IkeTerm.ENGLISH_LANGUAGE, "Interval Lower Bound", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
        ...
        set.concept("Field definition field", PublicIds.of(UUID.fromString("14171f07-e74f-409a-b555-06b478818f76"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("293a9980-baf8-4d28-a938-d102d04d1ef2")), IkeTerm.ENGLISH_LANGUAGE, "Field definition field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("d7d3959f-0743-5e88-a6db-5de059a7ccdd")))
                ;
        ...
        set.concept("Interval Upper Bound", PublicIds.of(UUID.fromString("6565f774-ff6c-4882-832f-31ddc462adf7"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("bdb2979c-4ab9-4262-95fb-de68acccf2bc")), IkeTerm.ENGLISH_LANGUAGE, "Interval Upper Bound", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("a5b0f7cc-7605-4e1e-ba4c-3da028c6de48")), IkeTerm.ENGLISH_LANGUAGE, "Interval Upper Bound", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("77d073b9-da92-5111-b3f4-e4b10aca8f06")))
                ;

        set.concept("STAMP field", PublicIds.of(UUID.fromString("3d821e64-a2ee-4414-8949-1bc92ef5d5b6"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("636175a0-1d83-43ba-bd94-1a4979ea17b2")), IkeTerm.ENGLISH_LANGUAGE, "STAMP field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("d2948b12-e23f-5c0d-9741-a2613b849db8")))
                ;

        set.concept("Component field", PublicIds.of(UUID.fromString("8bd36a0c-d05d-46b7-a79a-d11477705cc1"))).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("71037904-d49d-4bbd-a1f7-792c50e4593a")), IkeTerm.ENGLISH_LANGUAGE, "Component field", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                ...
                .semantic(IkeTerm.TINKAR_BASE_MODEL_COMPONENT_PATTERN, PublicIds.of(UUID.fromString("73c02ad4-723b-5532-8ac7-440906695f8e")))
                ;
