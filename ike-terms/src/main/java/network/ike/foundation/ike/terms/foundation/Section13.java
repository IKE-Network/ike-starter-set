...
final class Section13 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Language coordinate properties (SOLOR)", PublicIds.of("ea1a52f7-0305-5487-8766-e846330f167a")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("92c2cfd0-a05e-4c05-9be5-119334d94dc9"), IkeTerm.ENGLISH_LANGUAGE, "Groups the language-coordinate dimensions: which language, which dialect order, which description types in which preference order, and which modules a rendering surface consults when choosing text to show.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Language coordinate name (SOLOR)", PublicIds.of("42dff20f-5ed2-559a-91ad-91d44a573c63")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("2c8958d4-6d4d-49b8-a542-28a3943c3455"), IkeTerm.ENGLISH_LANGUAGE, "The field naming a stored language coordinate, so a surface can present saved coordinates by name.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
