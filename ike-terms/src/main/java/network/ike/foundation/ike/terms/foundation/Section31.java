...
final class Section31 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Version Properties (SOLOR)", PublicIds.of("93f844df-38e5-5167-ba94-2c948b8bd07c")).at(inception)
                ...
                .statedAxioms(PublicIds.of("d95584e0-8382-5536-959b-55dd12b05d45"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.OBJECT_PROPERTIES))))
        ...
        set.concept("Author for version (SOLOR)", PublicIds.of("4eb9de0d-7486-5f18-a9b4-82e3432f4103")).at(inception)
                ...
                .statedAxioms(PublicIds.of("65a484d3-31c0-5451-892f-9b00ad3f98c7"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.VERSION_PROPERTIES))))
        ...
        set.concept("Status for version (SOLOR)", PublicIds.of("0608e233-d79d-5076-985b-9b1ea4e14b4c")).at(inception)
                ...
                .statedAxioms(PublicIds.of("98b7920b-17b3-54f4-b66b-e61f05dd2ed2"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.VERSION_PROPERTIES))))
        ...
        set.concept("Path for version", PublicIds.of("ad3dd2dd-ddb0-584c-bea4-c6d9b91d461f")).at(inception)
                ...
                .statedAxioms(PublicIds.of("2fdff6d2-43d5-58ca-b9b4-e5f1fad67007"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.VERSION_PROPERTIES))))
        ...
        set.concept("Module for version (SOLOR)", PublicIds.of("67cd64f1-96d7-5110-b847-556c055ac063")).at(inception)
                ...
                .statedAxioms(PublicIds.of("88cdc29c-8629-57b6-b125-c2cec0a1df61"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.VERSION_PROPERTIES))))
        ...
        set.concept("Time for version (SOLOR)", PublicIds.of("a9b0dfb2-f463-5dae-8ba8-7f2e8385571b")).at(inception)
                ...
                .statedAxioms(PublicIds.of("5531ab29-6f3f-5507-b7e9-9d68549701ca"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.VERSION_PROPERTIES))))
        ...
        set.concept("Language concept nid for description (SOLOR)", PublicIds.of("cd56cceb-8507-5ae5-a928-16079fe6f832")).at(inception)
                ...
                .statedAxioms(PublicIds.of("98299aab-3ef8-5b53-9423-0973993d0503"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.DESCRIPTION_VERSION_PROPERTIES))))
