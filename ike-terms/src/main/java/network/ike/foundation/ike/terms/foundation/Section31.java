...
final class Section31 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Status for version (SOLOR)", PublicIds.of("0608e233-d79d-5076-985b-9b1ea4e14b4c")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("a7e2fdce-fc02-4757-86b3-5b0f07c848ce"), IkeTerm.ENGLISH_LANGUAGE, "Why a version's status field is recorded: to say whether the version is active, inactive, or withdrawn, so a view can accept or ignore it.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Path for version", PublicIds.of("ad3dd2dd-ddb0-584c-bea4-c6d9b91d461f")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("ac05c943-0344-4f6b-9408-1b0938013b38"), IkeTerm.ENGLISH_LANGUAGE, "Why a version's path field is recorded: to say which version-control path the version was committed on.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Module for version (SOLOR)", PublicIds.of("67cd64f1-96d7-5110-b847-556c055ac063")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("29e0c4cf-04bf-4b27-a875-0d9ab04fabba"), IkeTerm.ENGLISH_LANGUAGE, "Why a version's module field is recorded: to say which export and authoring boundary the version belongs to.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Time for version (SOLOR)", PublicIds.of("a9b0dfb2-f463-5dae-8ba8-7f2e8385571b")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("c7d65416-1aef-4748-b783-c8a58b4a1b2f"), IkeTerm.ENGLISH_LANGUAGE, "Why a version's time field is recorded: to say when the version was committed, so a view positioned at a moment can resolve what was current then.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Description type for description (SOLOR)", PublicIds.of("a00c5ad7-5b8a-5592-a28c-64057dd3caab")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("25a94665-5a99-40ae-9b3a-5dcd56f60c7e"), IkeTerm.ENGLISH_LANGUAGE, "Why a description version records its type: to say which role the description plays for its component -- fully qualified name, regular name, or definition -- so a rendering surface can pick by role.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Description dialect pair (SOLOR)", PublicIds.of("a27bbbf8-57b5-590c-8650-1247f6f963eb")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("bb2f8d1e-1897-4474-aff1-9e3b196fedf1"), IkeTerm.ENGLISH_LANGUAGE, "The pairing of a dialect with a description: the two-field shape a dialect semantic records, saying how acceptable one description is in one dialect. Its two children name the sides of that pair.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Dialect for dialect/description pair (SOLOR)", PublicIds.of("850bc47d-5235-5bce-99f4-c41f8a163d69")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("df8f266f-8448-43c7-b207-db1803058f54"), IkeTerm.ENGLISH_LANGUAGE, "The dialect side of a dialect-and-description pair: which dialect the paired acceptability judgment applies in.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Description for dialect/description pair (SOLOR)", PublicIds.of("1137767a-ad8b-5bc5-9842-a1f9b09d1ecc")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("28126a01-91fa-425c-a405-9b3d1a6321aa"), IkeTerm.ENGLISH_LANGUAGE, "The description side of a dialect-and-description pair: which description the paired acceptability judgment is about.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
