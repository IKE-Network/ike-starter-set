...
final class Section30 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Action properties (SOLOR)", PublicIds.of("80ba281c-7d47-57cf-8100-82b69bce998b")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("b2083605-6ae1-4611-8293-8dd2836058d7"), IkeTerm.ENGLISH_LANGUAGE, "Attributes of an action object", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("d5791b11-b4df-5185-9ca9-35c8dd89ca90"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.OBJECT_PROPERTIES))))
        ...
        set.concept("Role type to add (SOLOR)", PublicIds.of("0c3ca846-0374-5a5c-8da4-67e0e2e28868")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("418cd90f-353c-41ef-bebe-53a6b26380bc"), IkeTerm.ENGLISH_LANGUAGE, "Action - add role type", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Concept constraints(SOLOR)", PublicIds.of("081273cd-92dd-593c-9d9b-63d33838e70b")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("a5cd7454-d591-4eec-b673-54adaf5f6143"), IkeTerm.ENGLISH_LANGUAGE, "Defined filters for a given concept", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
