...
final class Section55 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Model concept", PublicIds.of(UUID.fromString("7bbd4210-381c-11e7-9598-0800200c9a66"))).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(UUID.fromString("3e65ef28-f915-4773-beb5-a068361499b3")), IkeTerm.ENGLISH_LANGUAGE, "", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
