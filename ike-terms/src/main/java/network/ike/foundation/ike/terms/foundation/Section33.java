...
final class Section33 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Reference Range (SOLOR)", PublicIds.of("87ce975b-309b-47f4-a6c6-4ae6df6649a1")).at(inception)
                ...
                .statedAxioms(PublicIds.of("d3c01223-8471-52b0-888e-c53d920e0675"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.TINKAR_MODEL_CONCEPT))))
        ...
        set.concept("Reference Range Minimum (SOLOR)", PublicIds.of("37c35a88-9e27-42ca-b626-186773c4b612")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("9144070a-f05d-430a-b74f-c520511557c2"), IkeTerm.ENGLISH_LANGUAGE, "The lowest possible value for a component", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("1934f2ef-705e-5bc5-9617-dfdafdb22f54"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.REFERENCE_RANGE))))
        ...
        set.concept("Reference Range Maximum (SOLOR)", PublicIds.of("72d58983-b1e1-4ca9-833f-0e40c1defd39")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("8b43571f-a594-411c-a26e-49b70daa04cc"), IkeTerm.ENGLISH_LANGUAGE, "The highest possible value for a component", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("22861d9d-154d-5c34-b325-5b6babe9fda6"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.REFERENCE_RANGE))))
