...
final class Section66 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Directed graph (SOLOR)", PublicIds.of("47a787a7-bdce-528d-bfcc-fde1add8d599")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("7411c406-b6d5-4778-8636-5a503bdbb421"), IkeTerm.ENGLISH_LANGUAGE, "Directed graph", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("EL++ digraph (SOLOR)", PublicIds.of("ee04d7db-3407-568f-9b93-7b1f9f5bb0fc")).at(inception)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("72c41b1d-f7e0-4d69-aef5-92430288ffb6"), IkeTerm.ENGLISH_LANGUAGE, "EL++ digraph (SOLOR)", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE)
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("2b649036-a2a3-47f3-9060-f7d2bcc19086"), IkeTerm.ENGLISH_LANGUAGE, "EL++ digraph", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.REGULAR_NAME_DESCRIPTION_TYPE)
                ...
                .statedAxioms(PublicIds.of("704783f9-4acc-529d-aad7-a260a9d72bd3"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.DIRECTED_GRAPH))))
