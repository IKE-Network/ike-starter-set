...
final class Section67 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Example UCUM Units (SOLOR)", PublicIds.of("80cd4978-314d-46e3-bc13-9980280ae955")).at(inception)
                ...
                .statedAxioms(PublicIds.of("fc087ef6-c9b1-54a8-9a79-f4d47579b989"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.PHENOMENON), leb.ConceptAxiom(IkeTerm.MEANING))))
