...
final class Section23 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Sandbox component (SOLOR)", PublicIds.of("c93829b2-aa78-5a84-ac9a-c34307844166")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("989ed925-0d60-4aae-a13d-8653b4433de4"), IkeTerm.ENGLISH_LANGUAGE, "An ISAAC-era marker for components in sandbox experimentation, retired to Legacy: sandbox scoping is carried by module and path dimensions.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Sandbox module (SOLOR)", PublicIds.of("c5daf0e9-30dc-5b3e-a521-d6e6e72c8a95")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("2e56cf98-c9a5-42d0-a68f-eafc7e00e3c9"), IkeTerm.ENGLISH_LANGUAGE, "The module for sandbox experimentation content.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
        ...
        set.concept("Sandbox path module (SOLOR)", PublicIds.of("715bd36d-6090-5b37-8ae7-88c9e532010e")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("6c78053c-0780-4cff-884e-c114f176c39f"), IkeTerm.ENGLISH_LANGUAGE, "The module for content specific to a sandbox path.", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
