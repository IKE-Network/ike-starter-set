...
final class Section23 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Sandbox component (SOLOR)", PublicIds.of("c93829b2-aa78-5a84-ac9a-c34307844166")).at(inception)
                ...
                .statedAxioms(PublicIds.of("fd59589b-5fbc-5422-908f-3a488f5cba59"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.OBJECT))))
        ...
        set.concept("Sandbox module (SOLOR)", PublicIds.of("c5daf0e9-30dc-5b3e-a521-d6e6e72c8a95")).at(inception)
                ...
                .statedAxioms(PublicIds.of("fba03f97-308f-5a38-9dc1-9139c36990d9"), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(IkeTerm.MODULE), leb.ConceptAxiom(IkeTerm.SANDBOX_COMPONENT))))
