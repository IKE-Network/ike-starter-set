...
final class Section50 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Data property set", PublicIds.of(UUID.fromString("6b8ed642-de72-4aee-953d-42e5db92c0ab"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("73ca869f-0593-5e07-8cf9-3516903fcf1d")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Logical set (IkeFoundation)")))))
