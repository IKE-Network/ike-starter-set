...
final class Section50 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Data property set", PublicIds.of("6b8ed642-de72-4aee-953d-42e5db92c0ab")).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of("c6a25965-da90-4471-98f1-1bc2c0ad2fa9"), IkeTerm.ENGLISH_LANGUAGE, "Data property set (SOLOR)", IkeTerm.DESCRIPTION_NOT_CASE_SENSITIVE, IkeTerm.DEFINITION_DESCRIPTION_TYPE)
