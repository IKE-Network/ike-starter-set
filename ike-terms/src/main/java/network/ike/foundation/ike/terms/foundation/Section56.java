...
final class Section56 {
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("Module", PublicIds.of(UUID.fromString("40d1c869-b509-32f8-b735-836eac577a67"))).at(inception)
                ...
                .statedAxioms(PublicIds.of(UUID.fromString("08ddbdb2-4c9b-51df-ac3f-b7f6031e57a8")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("STAMP dimensions (IkeFoundation)")))))
