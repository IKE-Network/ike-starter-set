...
canonical_url: https://ike.network/ike-starter-set/ike-bindings/dependencies.html
---

# Dependencies (SBOM)

Full transitive dependency graph for `ike-bindings` 1-chronology-builder-SNAPSHOT, generated from [bom.json](bom.json)[1] (CycloneDX 1.6) at build time. Same SBOM source as the SPDX-grouped [licenses.html](licenses.html)[2] and the curated [built-with.html](built-with.html)[3] — three views of the same data.
...
| `dev.ikm.elk` | `elk-owl-implementation` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-owl-model` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-reasoner` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-snomed` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-snomed-owl-el` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-snomed-reasoner` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-snomed-test` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-util-collections` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-util-common` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-util-concurrent` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-util-hashing` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-util-io` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.elk` | `elk-util-logging` | `0.40.0` | `Apache-2.0` | library |
| `dev.ikm.jpms` | `activej-bytebuf` | `4.3-r10` | `Apache-2.0` | library |
| `dev.ikm.jpms` | `activej-common` | `4.3-r8` | `Apache-2.0` | library |
| `dev.ikm.jpms` | `antlr4-runtime` | `4.13.2-r5` | `Apache-2.0` | library |
...
| `dev.ikm.tinkar` | `data-ephemeral-provider` | `1.127.2-chronology-builder-SNAPSHOT` | `Apache-2.0` | library |
| `dev.ikm.tinkar` | `data-spinedarray-provider` | `1.127.2-chronology-builder-SNAPSHOT` | `Apache-2.0` | library |
| `dev.ikm.tinkar` | `entity` | `1.127.2-chronology-builder-SNAPSHOT` | `Apache-2.0` | library |
| `dev.ikm.tinkar` | `entity-provider` | `1.127.2-chronology-builder-SNAPSHOT` | `Apache-2.0` | library |
| `dev.ikm.tinkar` | `executor-provider` | `1.127.2-chronology-builder-SNAPSHOT` | `Apache-2.0` | library |
| `dev.ikm.tinkar` | `reasoner-elk-snomed` | `1.127.2-chronology-builder-SNAPSHOT` | `Apache-2.0` | library |
| `dev.ikm.tinkar` | `reasoner-service` | `1.127.2-chronology-builder-SNAPSHOT` | `Apache-2.0` | library |
| `dev.ikm.tinkar` | `search-provider` | `1.127.2-chronology-builder-SNAPSHOT` | `Apache-2.0` | library |
...
| `org.apache.lucene` | `lucene-highlighter` | `10.4.0` | `Apache-2.0` | library |
| `org.apache.lucene` | `lucene-memory` | `10.4.0` | `Apache-2.0` | library |
| `org.apache.lucene` | `lucene-queries` | `10.4.0` | `Apache-2.0` | library |
| `org.apache.lucene` | `lucene-queryparser` | `10.4.0` | `Apache-2.0` | library |
| `org.apache.lucene` | `lucene-sandbox` | `10.4.0` | `Apache-2.0` | library |
...
- As a Maven artifact: pull `ike-bindings:​1-chronology-builder-SNAPSHOT` with `<classifier>cyclonedx</classifier><type>json</type>` from Nexus / Maven Central.
